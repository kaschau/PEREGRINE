...
//-------------------------------------------------------------------------------------------|
  MDRange4 range_cc({b.ng, b.ng, b.ng, 0},{b.ni+b.ng-1,
                                           ...
                                           b.nk+b.ng-1,
                                           b.ne});
  Kokkos::parallel_for("rk3 stage 1",
                       range_cc,
    ...
    b.Q(   i,j,k,l) =      b.rhs0(i,j,k,l) + b.rhs1(i,j,k,l);
  });
...
//-------------------------------------------------------------------------------------------|
  MDRange4 range_cc({b.ng, b.ng, b.ng, 0},{b.ni+b.ng-1,
                                           ...
                                           b.nk+b.ng-1,
                                           b.ne});
  Kokkos::parallel_for("rk3 stage 2",
                       range_cc,
                       KOKKOS_LAMBDA(const int i,
                                     const int j,
                                     const int k,
    ...
    b.Q(i,j,k,l) =   0.75 * b.rhs0(i,j,k,l)
                   + 0.25 * b.Q(   i,j,k,l)
...
//-------------------------------------------------------------------------------------------|
  MDRange4 range_cc({b.ng, b.ng, b.ng, 0},{b.ni+b.ng-1,
                                           ...
                                           b.nk+b.ng-1,
                                           b.ne});
  Kokkos::parallel_for("rk3 stage 3",
                       range_cc,
                       KOKKOS_LAMBDA(const int i,
                                     const int j,
                                     const int k,
