...
void dq2FD(block_ &b) {
  ...
  //-------------------------------------------------------------------------------------------|
  MDRange4 range_i({b.ng, b.ng, b.ng, 0},
                   {b.ni + b.ng, b.nj + b.ng - 1, b.nk + b.ng - 1, b.ne});
  Kokkos::parallel_for(
      ...
      KOKKOS_LAMBDA(const int i, const int j, const int k, const int l) {
        ...
        b.idqdy(i, j, k, l) =
            dqdE * 0.5 * (b.dEdy(i, j, k) + b.dEdy(i - 1, j, k));
        b.idqdz(i, j, k, l) =
            dqdE * 0.5 * (b.dEdz(i, j, k) + b.dEdz(i - 1, j, k));
      });

  MDRange4 range_j({b.ng, b.ng, b.ng, 0},
                   {b.ni + b.ng - 1, b.nj + b.ng, b.nk + b.ng - 1, b.ne});
  Kokkos::parallel_for(
      ...
      KOKKOS_LAMBDA(const int i, const int j, const int k, const int l) {
        ...
        b.jdqdy(i, j, k, l) =
            dqdN * 0.5 * (b.dNdy(i, j, k) + b.dNdy(i, j - 1, k));
        b.jdqdz(i, j, k, l) =
            dqdN * 0.5 * (b.dNdz(i, j, k) + b.dNdz(i, j - 1, k));
      });

  MDRange4 range_k({b.ng, b.ng, b.ng, 0},
                   {b.ni + b.ng - 1, b.nj + b.ng - 1, b.nk + b.ng, b.ne});
  Kokkos::parallel_for(
      ...
      KOKKOS_LAMBDA(const int i, const int j, const int k, const int l) {
        ...
        b.kdqdy(i, j, k, l) =
            dqdC * 0.5 * (b.dCdy(i, j, k) + b.dCdy(i, j, k - 1));
        b.kdqdz(i, j, k, l) =
            dqdC * 0.5 * (b.dCdz(i, j, k) + b.dCdz(i, j, k - 1));
      });
}
