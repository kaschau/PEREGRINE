...
void extract_sendBuffer3(threeDview view, face_ face, std::vector<int> slices){
    ...
    for (int g = 0; g < ng; g++) {
      ...
      twoDsubview bufferSlice = Kokkos::subview(buffer, g, Kokkos::ALL, Kokkos::ALL);
...
void extract_sendBuffer4(fourDview view, face_ face, std::vector<int> slices){
    ...
    for (int g = 0; g < ng; g++) {
      ...
      threeDsubview bufferSlice = Kokkos::subview(buffer, g, Kokkos::ALL, Kokkos::ALL, Kokkos::ALL);
