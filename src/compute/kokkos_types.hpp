...
using fourDviewHostsubview =
    Kokkos::View<double ****, Kokkos::LayoutStride, host_space>;
using fiveDviewHost =
    Kokkos::View<double *****, Kokkos::LayoutRight, host_space>;
#endif
