#ifndef __adiabaticNoSlipWall_postDqDxyz_H__
#define __adiabaticNoSlipWall_postDqDxyz_H__
...
inline void adiabaticNoSlipWall_postDqDxyz(const faceRecords &face,
                                           double tme) {
