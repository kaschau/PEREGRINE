#ifndef __supersonicInlet_postDqDxyz_H__
#define __supersonicInlet_postDqDxyz_H__

#include "boundaryConditions/faceRecords.hpp"

inline void supersonicInlet_postDqDxyz(const faceRecords &face, double tme) {
