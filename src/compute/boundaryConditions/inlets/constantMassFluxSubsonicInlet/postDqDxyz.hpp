#ifndef __constantMassFluxSubsonicInlet_postDqDxyz_H__
#define __constantMassFluxSubsonicInlet_postDqDxyz_H__

#include "boundaryConditions/faceRecords.hpp"

inline void constantMassFluxSubsonicInlet_postDqDxyz(const faceRecords &face,
                                                     double tme) {
