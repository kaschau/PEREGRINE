...
// The postDqDxyz hook of every boundary face, in one call. The jit includes the
...
PG_ABI void pgPostDqDxyz(int count, pgOut *q_, pgOut *Q_, pgIn *qh_,
                         pgOut *grads_, pgIn *S_, pgIn *qBcVals_,
                         pgIn *QBcVals_, pgIn *rot_, const int *nface,
