      ...
      KOKKOS_LAMBDA(const int i, const int j, const int k) {
        ...
        for (int nSub = 0; nSub < nChemSubSteps; nSub++) {
          ...
          // start scope of precomputed T**
          {
            ...
            if (T > 1000.0) {
              SMH[0] = -3.20502331e0 + 9.50158922e2 * Tinv + 3.3372792e0 * TN1 -
                       2.47012366e-5 * T + 8.32427963e-8 * T2 -
                       1.49638662e-11 * T3 + 1.00127688e-15 * T4;
              SMH[1] = -4.46682914e-1 - 2.54736599e4 * Tinv +
                       2.50000001e0 * TN1 - 1.15421486e-11 * T +
                       2.69269913e-15 * T2 - 3.94596029e-19 * T3 +
                       2.49098679e-23 * T4;
              SMH[2] = 4.78433864e0 - 2.92175791e4 * Tinv + 2.56942078e0 * TN1 -
                       4.29870568e-5 * T + 6.99140982e-9 * T2 -
                       8.34814992e-13 * T3 + 6.14168455e-17 * T4;
              SMH[3] = 5.45323129e0 + 1.08845772e3 * Tinv + 3.28253784e0 * TN1 +
                       7.4154377e-4 * T - 1.26327778e-7 * T2 +
                       1.74558796e-11 * T3 - 1.08358897e-15 * T4;
              SMH[4] = 4.4766961e0 - 3.858657e3 * Tinv + 3.09288767e0 * TN1 +
                       2.74214858e-4 * T + 2.10842047e-8 * T2 -
                       7.3288463e-12 * T3 + 5.8706188e-16 * T4;
              SMH[5] = 4.9667701e0 + 3.00042971e4 * Tinv + 3.03399249e0 * TN1 +
                       1.08845902e-3 * T - 2.73454197e-8 * T2 -
                       8.08683225e-12 * T3 + 8.4100496e-16 * T4;
              SMH[6] = 3.78510215e0 - 1.11856713e2 * Tinv + 4.0172109e0 * TN1 +
                       1.11991007e-3 * T - 1.05609692e-7 * T2 +
                       9.52053083e-12 * T3 - 5.39542675e-16 * T4;
              SMH[7] = 2.91615662e0 + 1.78617877e4 * Tinv + 4.16500285e0 * TN1 +
                       2.45415847e-3 * T - 3.16898708e-7 * T2 +
                       3.09321655e-11 * T3 - 1.43954153e-15 * T4;
              SMH[8] = 5.48497999e0 - 7.10124364e4 * Tinv + 2.87846473e0 * TN1 +
                       4.85456841e-4 * T + 2.40742758e-8 * T2 -
                       1.08906541e-11 * T3 + 8.80396915e-16 * T4;
              SMH[9] = 6.17119324e0 - 4.6263604e4 * Tinv + 2.87410113e0 * TN1 +
                       1.82819646e-3 * T - 2.34824328e-7 * T2 +
                       2.16816291e-11 * T3 - 9.38637835e-16 * T4;
              SMH[10] = 8.62650169e0 - 5.09259997e4 * Tinv +
                        2.29203842e0 * TN1 + 2.32794319e-3 * T -
                        3.35319912e-7 * T2 + 3.48255e-11 * T3 -
                        1.69858183e-15 * T4;
              SMH[11] = 8.48007179e0 - 1.67755843e4 * Tinv +
                        2.28571772e0 * TN1 + 3.61995019e-3 * T -
                        4.97857247e-7 * T2 + 4.9640387e-11 * T3 -
                        2.33577197e-15 * T4;
              SMH[12] = 1.8437318e1 + 9.46834459e3 * Tinv + 7.4851495e-2 * TN1 +
                        6.69547335e-3 * T - 9.55476348e-7 * T2 +
                        1.01910446e-10 * T3 - 5.0907615e-15 * T4;
              SMH[13] = 7.81868772e0 + 1.41518724e4 * Tinv +
                        2.71518561e0 * TN1 + 1.03126372e-3 * T -
                        1.66470962e-7 * T2 + 1.9171084e-11 * T3 -
                        1.01823858e-15 * T4;
              SMH[14] = 2.27163806e0 + 4.8759166e4 * Tinv + 3.85746029e0 * TN1 +
                        2.20718513e-3 * T - 3.69135673e-7 * T2 +
                        4.36241823e-11 * T3 - 2.36042082e-15 * T4;
              SMH[15] = 9.79834492e0 - 4.01191815e3 * Tinv +
                        2.77217438e0 * TN1 + 2.47847763e-3 * T -
                        4.14076022e-7 * T2 + 4.90968148e-11 * T3 -
                        2.66754356e-15 * T4;
              SMH[16] = 1.3656323e1 + 1.39958323e4 * Tinv + 1.76069008e0 * TN1 +
                        4.60000041e-3 * T - 7.37098022e-7 * T2 +
                        8.38676767e-11 * T3 - 4.4192782e-15 * T4;
              SMH[17] = 2.929575e0 - 1.2783252e2 * Tinv + 3.770799e0 * TN1 +
                        3.9357485e-3 * T - 4.42730667e-7 * T2 +
                        3.28702583e-11 * T3 - 1.056308e-15 * T4;
              SMH[18] = -1.23028121e0 - 2.59359992e4 * Tinv +
                        4.14756964e0 * TN1 + 2.98083332e-3 * T -
                        3.9549142e-7 * T2 + 3.89510143e-11 * T3 -
                        1.80617607e-15 * T4;
              SMH[19] = 6.4023701e-1 - 4.8316688e4 * Tinv + 4.278034e0 * TN1 +
                        2.3781402e-3 * T - 2.71683483e-7 * T2 +
                        2.1219005e-11 * T3 - 7.4431895e-16 * T4;
              SMH[20] = 7.78732378e0 - 3.46128739e4 * Tinv + 3.016724e0 * TN1 +
                        5.1651146e-3 * T - 7.80137248e-7 * T2 +
                        8.480274e-11 * T3 - 4.3130352e-15 * T4;
              SMH[21] = 1.03053693e1 - 4.93988614e3 * Tinv +
                        2.03611116e0 * TN1 + 7.32270755e-3 * T -
                        1.11846319e-6 * T2 + 1.22685769e-10 * T3 -
                        6.28530305e-15 * T4;
              SMH[22] = 1.34624343e1 - 1.285752e4 * Tinv + 1.95465642e0 * TN1 +
                        8.6986361e-3 * T - 1.33034445e-6 * T2 +
                        1.46014741e-10 * T3 - 7.4820788e-15 * T4;
              SMH[23] = 1.51156107e1 + 1.14263932e4 * Tinv + 1.0718815e0 * TN1 +
                        1.08426339e-2 * T - 1.67093445e-6 * T2 +
                        1.84510001e-10 * T3 - 9.5001445e-15 * T4;
              SMH[24] = -3.9302595e0 - 1.9327215e4 * Tinv + 5.6282058e0 * TN1 +
                        2.04267005e-3 * T - 2.65575783e-7 * T2 +
                        2.38550433e-11 * T3 - 9.703916e-16 * T4;
              SMH[25] = 6.32247205e-1 + 7.55105311e3 * Tinv +
                        4.51129732e0 * TN1 + 4.50179872e-3 * T -
                        6.94899392e-7 * T2 + 7.69454902e-11 * T3 -
                        3.974191e-15 * T4;
              SMH[26] = -5.0320879e0 - 4.9032178e2 * Tinv + 5.9756699e0 * TN1 +
                        4.0652957e-3 * T - 4.5727075e-7 * T2 +
                        3.39192008e-11 * T3 - 1.08800855e-15 * T4;
              SMH[27] = -3.4807917e0 + 2.2593122e4 * Tinv + 5.4041108e0 * TN1 +
                        5.8615295e-3 * T - 7.04385617e-7 * T2 +
                        5.69770425e-11 * T3 - 2.04924315e-15 * T4;
              SMH[28] = -1.124305e1 - 1.7482449e4 * Tinv + 6.5007877e0 * TN1 +
                        7.1623655e-3 * T - 9.46360533e-7 * T2 +
                        9.23400083e-11 * T3 - 4.51819435e-15 * T4;
              SMH[29] = -1.331335e1 + 9.235703e2 * Tinv + 6.732257e0 * TN1 +
                        7.45417e-3 * T - 8.24983167e-7 * T2 +
                        6.01001833e-11 * T3 - 1.883102e-15 * T4;
              SMH[30] = -1.5515297e1 - 7.9762236e3 * Tinv + 7.7097479e0 * TN1 +
                        8.0157425e-3 * T - 8.78670633e-7 * T2 +
                        6.32402933e-11 * T3 - 1.94313595e-15 * T4;
            } else {
              SMH[0] = 6.83010238e-1 + 9.17935173e2 * Tinv +
                       2.34433112e0 * TN1 + 3.99026037e-3 * T -
                       3.2463585e-6 * T2 + 1.67976745e-9 * T3 -
                       3.68805881e-13 * T4;
              SMH[1] = -4.46682853e-1 - 2.54736599e4 * Tinv + 2.5e0 * TN1 +
                       3.5266641e-13 * T - 3.32653273e-16 * T2 +
                       1.91734693e-19 * T3 - 4.63866166e-23 * T4;
              SMH[2] = 2.05193346e0 - 2.91222592e4 * Tinv + 3.1682671e0 * TN1 -
                       1.63965942e-3 * T + 1.10717733e-6 * T2 -
                       5.10672187e-10 * T3 + 1.05632986e-13 * T4;
              SMH[3] = 3.65767573e0 + 1.06394356e3 * Tinv + 3.78245636e0 * TN1 -
                       1.49836708e-3 * T + 1.641217e-6 * T2 -
                       8.06774591e-10 * T3 + 1.62186419e-13 * T4;
              SMH[4] = -1.03925458e-1 - 3.61508056e3 * Tinv +
                       3.99201543e0 * TN1 - 1.20065876e-3 * T +
                       7.69656402e-7 * T2 - 3.23427778e-10 * T3 +
                       6.8205735e-14 * T4;
              SMH[5] = -8.49032208e-1 + 3.02937267e4 * Tinv +
                       4.19864056e0 * TN1 - 1.01821705e-3 * T +
                       1.08673369e-6 * T2 - 4.57330885e-10 * T3 +
                       8.85989085e-14 * T4;
              SMH[6] = 3.71666245e0 - 2.9480804e2 * Tinv + 4.30179801e0 * TN1 -
                       2.37456026e-3 * T + 3.52638152e-6 * T2 -
                       2.02303245e-9 * T3 + 4.64612562e-13 * T4;
              SMH[7] = 3.43505074e0 + 1.77025821e4 * Tinv + 4.27611269e0 * TN1 -
                       2.71411208e-4 * T + 2.78892835e-6 * T2 -
                       1.79809011e-9 * T3 + 4.31227181e-13 * T4;
              SMH[8] = 2.08401108e0 - 7.07972934e4 * Tinv + 3.48981665e0 * TN1 +
                       1.61917771e-4 * T - 2.81498442e-7 * T2 +
                       2.63514439e-10 * T3 - 7.03045335e-14 * T4;
              SMH[9] = 1.56253185e0 - 4.60040401e4 * Tinv + 3.76267867e0 * TN1 +
                       4.84436072e-4 * T + 4.65816402e-7 * T2 -
                       3.20909294e-10 * T3 + 8.43708595e-14 * T4;
              SMH[10] = -7.69118967e-1 - 5.04968163e4 * Tinv +
                        4.19860411e0 * TN1 - 1.1833071e-3 * T +
                        1.37216037e-6 * T2 - 5.57346651e-10 * T3 +
                        9.71573685e-14 * T4;
              SMH[11] = 1.60456433e0 - 1.64449988e4 * Tinv + 3.6735904e0 * TN1 +
                        1.00547587e-3 * T + 9.55036427e-7 * T2 -
                        5.72597854e-10 * T3 + 1.27192867e-13 * T4;
              SMH[12] = -4.64130376e0 + 1.02466476e4 * Tinv +
                        5.14987613e0 * TN1 - 6.8354894e-3 * T +
                        8.19667665e-6 * T2 - 4.03952522e-9 * T3 +
                        8.3346978e-13 * T4;
              SMH[13] = 3.50840928e0 + 1.4344086e4 * Tinv + 3.57953347e0 * TN1 -
                        3.0517684e-4 * T + 1.69469055e-7 * T2 +
                        7.55838237e-11 * T3 - 4.52212249e-14 * T4;
              SMH[14] = 9.90105222e0 + 4.83719697e4 * Tinv +
                        2.35677352e0 * TN1 + 4.49229838e-3 * T -
                        1.18726045e-6 * T2 + 2.04932518e-10 * T3 -
                        7.1849774e-15 * T4;
              SMH[15] = 3.39437243e0 - 3.83956496e3 * Tinv +
                        4.22118584e0 * TN1 - 1.62196266e-3 * T +
                        2.29665743e-6 * T2 - 1.10953411e-9 * T3 +
                        2.16884432e-13 * T4;
              SMH[16] = 6.028129e-1 + 1.43089567e4 * Tinv + 4.79372315e0 * TN1 -
                        4.95416684e-3 * T + 6.22033347e-6 * T2 -
                        3.16071051e-9 * T3 + 6.5886326e-13 * T4;
              SMH[17] = 1.3152177e1 - 9.786011e2 * Tinv + 2.106204e0 * TN1 +
                        3.6082975e-3 * T + 8.89745333e-7 * T2 -
                        6.14803e-10 * T3 + 1.037805e-13 * T4;
              SMH[18] = 1.39397051e1 - 2.64289807e4 * Tinv +
                        8.08681094e-1 * TN1 + 1.16807815e-2 * T -
                        5.91953025e-6 * T2 + 2.33460364e-9 * T3 -
                        4.25036487e-13 * T4;
              SMH[19] = 5.920391e0 - 4.8621794e4 * Tinv + 3.2815483e0 * TN1 +
                        3.48823955e-3 * T - 3.975874e-7 * T2 -
                        1.00870267e-10 * T3 + 4.90947725e-14 * T4;
              SMH[20] = 8.51054025e0 - 3.48598468e4 * Tinv +
                        3.21246645e0 * TN1 + 7.5739581e-4 * T +
                        4.32015687e-6 * T2 - 2.98048206e-9 * T3 +
                        7.35754365e-13 * T4;
              SMH[21] = 4.09733096e0 - 5.08977593e3 * Tinv +
                        3.95920148e0 * TN1 - 3.78526124e-3 * T +
                        9.51650487e-6 * T2 - 5.76323961e-9 * T3 +
                        1.34942187e-12 * T4;
              SMH[22] = 4.70720924e0 - 1.28416265e4 * Tinv +
                        4.30646568e0 * TN1 - 2.09329446e-3 * T +
                        8.28571345e-6 * T2 - 4.99272172e-9 * T3 +
                        1.15254502e-12 * T4;
              SMH[23] = 2.66682316e0 + 1.15222055e4 * Tinv +
                        4.29142492e0 * TN1 - 2.75077135e-3 * T +
                        9.99063813e-6 * T2 - 5.90388571e-9 * T3 +
                        1.34342886e-12 * T4;
              SMH[24] = 1.2490417e1 - 2.0059449e4 * Tinv + 2.2517214e0 * TN1 +
                        8.8275105e-3 * T - 3.95485017e-6 * T2 +
                        1.43964658e-9 * T3 - 2.53324055e-13 * T4;
              SMH[25] = 1.2215648e1 + 7.04291804e3 * Tinv + 2.1358363e0 * TN1 +
                        9.05943605e-3 * T - 2.89912457e-6 * T2 +
                        7.7866464e-10 * T3 - 1.00728807e-13 * T4;
              SMH[26] = 9.5714535e0 - 1.5214766e3 * Tinv + 3.4090624e0 * TN1 +
                        5.369287e-3 * T + 3.1524875e-7 * T2 +
                        5.96548592e-10 * T3 + 1.43369255e-13 * T4;
              SMH[27] = 4.1030159e0 + 2.1572878e4 * Tinv + 4.7294595e0 * TN1 -
                        1.5966429e-3 * T + 7.92248683e-6 * T2 -
                        4.78821758e-9 * T3 + 1.0965556e-12 * T4;
              SMH[28] = 1.7173214e1 - 1.9245629e4 * Tinv + 1.3631835e0 * TN1 +
                        9.9069105e-3 * T + 2.08284333e-6 * T2 -
                        2.77962958e-9 * T3 + 7.9232855e-13 * T4;
              SMH[29] = 1.614534e1 - 1.074826e3 * Tinv + 1.493307e0 * TN1 +
                        1.046259e-2 * T + 7.47799e-7 * T2 - 1.39076e-9 * T3 +
                        3.579073e-13 * T4;
              SMH[30] = 2.1136034e1 - 1.0312346e4 * Tinv + 1.0491173e0 * TN1 +
          ...
          double RKLOW[21];
          RKLOW[0] = exp(4.22794408e1 - 9e-1 * logT + 8.55468335e2 * Tinv);
          RKLOW[1] = exp(6.37931383e1 - 3.42e0 * logT - 4.24463259e4 * Tinv);
          RKLOW[2] = exp(6.54619238e1 - 3.74e0 * logT - 9.74227469e2 * Tinv);
          RKLOW[3] = exp(5.55621468e1 - 2.57e0 * logT - 7.17083751e2 * Tinv);
          RKLOW[4] = exp(6.33329483e1 - 3.14e0 * logT - 6.18956501e2 * Tinv);
          RKLOW[5] = exp(7.69748493e1 - 5.11e0 * logT - 3.57032226e3 * Tinv);
          RKLOW[6] = exp(6.98660102e1 - 4.8e0 * logT - 2.79788467e3 * Tinv);
          RKLOW[7] = exp(7.68923562e1 - 4.76e0 * logT - 1.22784867e3 * Tinv);
          RKLOW[8] = exp(1.11312542e2 - 9.588e0 * logT - 2.566405e3 * Tinv);
          RKLOW[9] = exp(1.15700234e2 - 9.67e0 * logT - 3.13000767e3 * Tinv);
          RKLOW[10] = exp(3.54348644e1 - 6.4e-1 * logT - 2.50098684e4 * Tinv);
          RKLOW[11] = exp(6.3111756e1 - 3.4e0 * logT - 1.80145126e4 * Tinv);
          RKLOW[12] = exp(9.57409899e1 - 7.64e0 * logT - 5.98827834e3 * Tinv);
          RKLOW[13] = exp(6.9414025e1 - 3.86e0 * logT - 1.67067934e3 * Tinv);
          RKLOW[14] = exp(1.35001549e2 - 1.194e1 * logT - 4.9163262e3 * Tinv);
          RKLOW[15] = exp(9.14494773e1 - 7.297e0 * logT - 2.36511834e3 * Tinv);
          RKLOW[16] = exp(1.17075165e2 - 9.31e0 * logT - 5.02512164e4 * Tinv);
          RKLOW[17] = exp(9.68908955e1 - 7.62e0 * logT - 3.50742017e3 * Tinv);
          RKLOW[18] = exp(9.50941235e1 - 7.08e0 * logT - 3.36400342e3 * Tinv);
          RKLOW[19] = exp(1.38440285e2 - 1.2e1 * logT - 3.00309643e3 * Tinv);
          RKLOW[20] = exp(8.93324137e1 - 6.66e0 * logT - 3.52251667e3 * Tinv);
          ...
          CTB = CTOT + 1.4e0 * cs[0] + 1.44e1 * cs[5] + cs[9] +
                7.5e-1 * cs[10] + 2.6e0 * cs[11] + 2e0 * cs[15] + 2e0 * cs[13] +
                2e0 * cs[14];
          ...
          DEN = RF[47] + RF[48] + RF[49] + RF[50] + RF[51] + RF[52] + RF[53] +
                ...
                RB[35] + RB[58] + RB[66] + RB[67] + RB[68] + RB[79] + RB[116] +
                RB[122] + RB[124] + RB[129] + RB[159];
          ...
          DEN = RF[40] + RF[41] + RF[42] + RF[43] + RF[44] + RF[45] + RF[46] +
                ...
                RB[73] + RB[74] + RB[75] + RB[89] + RB[139] + RB[148] + RB[158];
          double A4_0 =
