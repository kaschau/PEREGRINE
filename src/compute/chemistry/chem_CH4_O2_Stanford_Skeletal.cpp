...
//-------------------------------------------------------------------------------------------|
  ...
  omega[0] = th.MW[0] * ( -q[1] -q[2] -q[3] -q[5] +q[10] +q[21] +q[26] +q[32] +q[33] +q[34]);
  omega[1] = th.MW[1] * ( -q[0] +q[1] +q[2] +q[3] +2.0*q[5] -q[6] +q[7] +q[8] -q[9] -q[10] -q[11] -q[12] +q[18] +q[19] -q[21] -q[24] +q[25] +q[26] +q[28] +q[29] +q[31] +q[35] +q[36] +q[37]);
  omega[2] = th.MW[2] * ( -q[0] -q[9] +q[10] +q[13] +q[14] +q[15] -q[17] +q[27] -q[29] -q[30] -q[37]);
  omega[3] = th.MW[3] * ( q[0] -q[1] -q[2] +q[4] -q[6] +q[12] -q[13] -q[16] +q[17] -q[22] -q[25] -q[26] +q[29] -q[35]);
  omega[4] = th.MW[4] * ( q[0] +q[1] +q[2] -q[3] -2.0*q[4] +q[6] +q[7] +q[8] +2.0*q[11] +q[13] -q[14] -q[15] -q[18] -q[19] +q[20] +q[22] -q[23] +q[28] +q[30] +q[35] -q[36]);
  omega[5] = th.MW[5] * ( q[9] -q[10] -q[11] -q[12] -q[13] -q[14] -q[15] -q[20] -q[27] -q[28] +q[37]);
  omega[6] = th.MW[6] * ( q[3] +q[4] -q[7] -q[8] +q[12] +q[14] +q[15] +q[23] +q[36]);
  omega[7] = th.MW[7] * ( q[21] +q[22] +q[23] -q[24] -q[25] -q[26] -q[27] -q[28] -q[29] -q[30] -q[31]);
  omega[8] = th.MW[8] * ( -q[21] -q[22] -q[23] +q[24] +q[27] +q[31]);
  omega[9] = th.MW[9] * ( -q[16] -q[17] -q[18] -q[19] -q[20] +q[26] +q[31] +q[32] +q[33] +q[34] +q[35] +q[36] +q[37]);
