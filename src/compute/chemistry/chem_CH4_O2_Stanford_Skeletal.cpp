...
// --------------------------------------------------------------|
  ...
  S_tbc[5] = 2.5*cs(0,id) + cs(1,id) + cs(2,id) + cs(3,id) + cs(4,id) + cs(5,id) + 12.0*cs(6,id) + cs(7,id) + 2.0*cs(8,id) + 1.9*cs(9,id) + 2.5*cs(10,id) + 3.8*cs(11,id);

  S_tbc[6] = 2.5*cs(0,id) + cs(1,id) + cs(2,id) + cs(3,id) + cs(4,id) + cs(5,id) + 12.0*cs(6,id) + cs(7,id) + 2.0*cs(8,id) + 1.9*cs(9,id) + 2.5*cs(10,id) + 3.8*cs(11,id);

  S_tbc[7] = 3.0*cs(0,id) + cs(1,id) + 1.5*cs(2,id) + cs(3,id) + cs(4,id) + cs(5,id) + cs(7,id) + 7.0*cs(8,id) + 1.9*cs(9,id) + 2.5*cs(10,id) + 3.8*cs(11,id);

  S_tbc[9] = 2.0*cs(0,id) + cs(1,id) + 0.78*cs(2,id) + cs(3,id) + cs(4,id) + cs(5,id) + 14.0*cs(6,id) + cs(7,id) + 2.0*cs(8,id) + 1.9*cs(9,id) + 2.5*cs(10,id) + 3.8*cs(11,id);

  S_tbc[16] = 2.5*cs(0,id) + cs(1,id) + cs(2,id) + cs(3,id) + cs(4,id) + cs(5,id) + 12.0*cs(6,id) + cs(7,id) + 2.0*cs(8,id) + 1.9*cs(9,id) + 2.5*cs(10,id) + 3.8*cs(11,id);

  S_tbc[24] = 2.0*cs(0,id) + cs(1,id) + cs(2,id) + cs(3,id) + cs(4,id) + cs(5,id) + 6.0*cs(6,id) + cs(7,id) + 2.0*cs(8,id) + 1.5*cs(9,id) + 2.5*cs(10,id) + 2.0*cs(11,id);

  S_tbc[32] = 2.0*cs(0,id) + cs(1,id) + cs(2,id) + cs(3,id) + cs(4,id) + cs(5,id) + 6.0*cs(6,id) + cs(7,id) + 2.0*cs(8,id) + 1.5*cs(9,id) + 2.5*cs(10,id) + 2.0*cs(11,id);
  ...
  q_f[0] =   S_tbc[0] * k_f[0] * cs(1,id) * cs(2,id);
  q_b[0] = - S_tbc[0] * k_f[0]/K_c[0] * cs(3,id) * cs(4,id);
  q[  0] =   q_f[0] + q_b[0];

  q_f[1] =   S_tbc[1] * k_f[1] * cs(0,id) * cs(3,id);
  q_b[1] = - S_tbc[1] * k_f[1]/K_c[1] * cs(1,id) * cs(4,id);
  q[  1] =   q_f[1] + q_b[1];

  q_f[2] =   S_tbc[2] * k_f[2] * cs(0,id) * cs(3,id);
  q_b[2] = - S_tbc[2] * k_f[2]/K_c[2] * cs(1,id) * cs(4,id);
  q[  2] =   q_f[2] + q_b[2];

  q_f[3] =   S_tbc[3] * k_f[3] * cs(0,id) * cs(4,id);
  q_b[3] = - S_tbc[3] * k_f[3]/K_c[3] * cs(1,id) * cs(6,id);
  q[  3] =   q_f[3] + q_b[3];

  q_f[4] =   S_tbc[4] * k_f[4] * pow(cs(4,id),2.0);
  q_b[4] = - S_tbc[4] * k_f[4]/K_c[4] * cs(3,id) * cs(6,id);
  q[  4] =   q_f[4] + q_b[4];

  q_f[5] =   S_tbc[5] * k_f[5] * cs(0,id);
  q_b[5] = - S_tbc[5] * k_f[5]/K_c[5] * pow(cs(1,id),2.0);
  q[  5] =   q_f[5] + q_b[5];

  q_f[6] =   S_tbc[6] * k_f[6] * cs(1,id) * cs(3,id);
  q_b[6] = - S_tbc[6] * k_f[6]/K_c[6] * cs(4,id);
  q[  6] =   q_f[6] + q_b[6];

  q_f[7] =   S_tbc[7] * k_f[7] * cs(6,id);
  q_b[7] = - S_tbc[7] * k_f[7]/K_c[7] * cs(1,id) * cs(4,id);
  q[  7] =   q_f[7] + q_b[7];

  q_f[8] =   S_tbc[8] * k_f[8] * pow(cs(6,id),2.0);
  q_b[8] = - S_tbc[8] * k_f[8]/K_c[8] * cs(1,id) * cs(4,id) * cs(6,id);
  q[  8] =   q_f[8] + q_b[8];

  q_f[9] =   k_f[9] * cs(1,id) * cs(2,id);
  q_b[9] = - k_f[9]/K_c[9] * cs(5,id);
  q[  9] =   q_f[9] + q_b[9];

  q_f[10] =   S_tbc[10] * k_f[10] * cs(1,id) * cs(5,id);
  q_b[10] = - S_tbc[10] * k_f[10]/K_c[10] * cs(0,id) * cs(2,id);
  q[  10] =   q_f[10] + q_b[10];

  q_f[11] =   S_tbc[11] * k_f[11] * cs(1,id) * cs(5,id);
  q_b[11] = - S_tbc[11] * k_f[11]/K_c[11] * pow(cs(4,id),2.0);
  q[  11] =   q_f[11] + q_b[11];

  q_f[12] =   S_tbc[12] * k_f[12] * cs(1,id) * cs(5,id);
  q_b[12] = - S_tbc[12] * k_f[12]/K_c[12] * cs(3,id) * cs(6,id);
  q[  12] =   q_f[12] + q_b[12];

  q_f[13] =   S_tbc[13] * k_f[13] * cs(3,id) * cs(5,id);
  q_b[13] = - S_tbc[13] * k_f[13]/K_c[13] * cs(2,id) * cs(4,id);
  q[  13] =   q_f[13] + q_b[13];

  q_f[14] =   S_tbc[14] * k_f[14] * cs(4,id) * cs(5,id);
  q_b[14] = - S_tbc[14] * k_f[14]/K_c[14] * cs(2,id) * cs(6,id);
  q[  14] =   q_f[14] + q_b[14];

  q_f[15] =   S_tbc[15] * k_f[15] * cs(4,id) * cs(5,id);
  q_b[15] = - S_tbc[15] * k_f[15]/K_c[15] * cs(2,id) * cs(6,id);
  q[  15] =   q_f[15] + q_b[15];

  q_f[16] =   k_f[16] * cs(3,id) * cs(9,id);
  q_b[16] = - k_f[16]/K_c[16] * cs(11,id);
  q[  16] =   q_f[16] + q_b[16];

  q_f[17] =   S_tbc[17] * k_f[17] * cs(2,id) * cs(9,id);
  q_b[17] = - S_tbc[17] * k_f[17]/K_c[17] * cs(3,id) * cs(11,id);
  q[  17] =   q_f[17] + q_b[17];

  q_f[18] =   S_tbc[18] * k_f[18] * cs(4,id) * cs(9,id);
  q_b[18] = - S_tbc[18] * k_f[18]/K_c[18] * cs(1,id) * cs(11,id);
  q[  18] =   q_f[18] + q_b[18];

  q_f[19] =   S_tbc[19] * k_f[19] * cs(4,id) * cs(9,id);
  q_b[19] = - S_tbc[19] * k_f[19]/K_c[19] * cs(1,id) * cs(11,id);
  q[  19] =   q_f[19] + q_b[19];

  q_f[20] =   S_tbc[20] * k_f[20] * cs(5,id) * cs(9,id);
  q_b[20] = - S_tbc[20] * k_f[20]/K_c[20] * cs(4,id) * cs(11,id);
  q[  20] =   q_f[20] + q_b[20];

  q_f[21] =   S_tbc[21] * k_f[21] * cs(1,id) * cs(8,id);
  q_b[21] = - S_tbc[21] * k_f[21]/K_c[21] * cs(0,id) * cs(7,id);
  q[  21] =   q_f[21] + q_b[21];

  q_f[22] =   S_tbc[22] * k_f[22] * cs(3,id) * cs(8,id);
  q_b[22] = - S_tbc[22] * k_f[22]/K_c[22] * cs(4,id) * cs(7,id);
  q[  22] =   q_f[22] + q_b[22];

  q_f[23] =   S_tbc[23] * k_f[23] * cs(4,id) * cs(8,id);
  q_b[23] = - S_tbc[23] * k_f[23]/K_c[23] * cs(6,id) * cs(7,id);
  q[  23] =   q_f[23] + q_b[23];

  q_f[24] =   k_f[24] * cs(1,id) * cs(7,id);
  q_b[24] = - k_f[24]/K_c[24] * cs(8,id);
  q[  24] =   q_f[24] + q_b[24];

  q_f[25] =   S_tbc[25] * k_f[25] * cs(3,id) * cs(7,id);
  q_b[25] = - S_tbc[25] * k_f[25]/K_c[25] * cs(1,id) * cs(10,id);
  q[  25] =   q_f[25] + q_b[25];

  q_f[26] =   S_tbc[26] * k_f[26] * cs(3,id) * cs(7,id);
  q_b[26] = - S_tbc[26] * k_f[26]/K_c[26] * cs(0,id) * cs(1,id) * cs(9,id);
  q[  26] =   q_f[26];

  q_f[27] =   S_tbc[27] * k_f[27] * cs(5,id) * cs(7,id);
  q_b[27] = - S_tbc[27] * k_f[27]/K_c[27] * cs(2,id) * cs(8,id);
  q[  27] =   q_f[27] + q_b[27];

  q_f[28] =   S_tbc[28] * k_f[28] * cs(5,id) * cs(7,id);
  q_b[28] = - S_tbc[28] * k_f[28]/K_c[28] * cs(1,id) * cs(4,id) * cs(10,id);
  q[  28] =   q_f[28];

  q_f[29] =   S_tbc[29] * k_f[29] * cs(2,id) * cs(7,id);
  q_b[29] = - S_tbc[29] * k_f[29]/K_c[29] * cs(1,id) * cs(3,id) * cs(10,id);
  q[  29] =   q_f[29];

  q_f[30] =   S_tbc[30] * k_f[30] * cs(2,id) * cs(7,id);
  q_b[30] = - S_tbc[30] * k_f[30]/K_c[30] * cs(4,id) * cs(10,id);
  q[  30] =   q_f[30] + q_b[30];

  q_f[31] =   S_tbc[31] * k_f[31] * cs(7,id) * cs(10,id);
  q_b[31] = - S_tbc[31] * k_f[31]/K_c[31] * cs(1,id) * cs(8,id) * cs(9,id);
  q[  31] =   q_f[31];

  q_f[32] =   k_f[32] * cs(10,id);
  q_b[32] = - k_f[32]/K_c[32] * cs(0,id) * cs(9,id);
  q[  32] =   q_f[32] + q_b[32];

  q_f[33] =   S_tbc[33] * k_f[33] * cs(1,id) * cs(10,id);
  q_b[33] = - S_tbc[33] * k_f[33]/K_c[33] * cs(0,id) * cs(1,id) * cs(9,id);
  q[  33] =   q_f[33];

  q_f[34] =   S_tbc[34] * k_f[34] * cs(1,id) * cs(10,id);
  q_b[34] = - S_tbc[34] * k_f[34]/K_c[34] * cs(0,id) * cs(1,id) * cs(9,id);
  q[  34] =   q_f[34];

  q_f[35] =   S_tbc[35] * k_f[35] * cs(3,id) * cs(10,id);
  q_b[35] = - S_tbc[35] * k_f[35]/K_c[35] * cs(1,id) * cs(4,id) * cs(9,id);
  q[  35] =   q_f[35];

  q_f[36] =   S_tbc[36] * k_f[36] * cs(4,id) * cs(10,id);
  q_b[36] = - S_tbc[36] * k_f[36]/K_c[36] * cs(1,id) * cs(6,id) * cs(9,id);
  q[  36] =   q_f[36];

  q_f[37] =   S_tbc[37] * k_f[37] * cs(2,id) * cs(10,id);
  q_b[37] = - S_tbc[37] * k_f[37]/K_c[37] * cs(1,id) * cs(5,id) * cs(9,id);
  q[  37] =   q_f[37];
