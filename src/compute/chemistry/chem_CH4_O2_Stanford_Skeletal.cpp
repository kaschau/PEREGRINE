...
// --------------------------------------------------------------|
  ...
  cTBC[0] = 2.5*cs[0] + cs[1] + cs[2] + cs[3] + cs[4] + cs[5] + 12.0*cs[6] + cs[7] + 2.0*cs[8] + 1.9*cs[9] + 2.5*cs[10] + 3.8*cs[11];

  cTBC[1] = 2.5*cs[0] + cs[1] + cs[2] + cs[3] + cs[4] + cs[5] + 12.0*cs[6] + cs[7] + 2.0*cs[8] + 1.9*cs[9] + 2.5*cs[10] + 3.8*cs[11];

  cTBC[2] = 3.0*cs[0] + cs[1] + 1.5*cs[2] + cs[3] + cs[4] + cs[5] + cs[7] + 7.0*cs[8] + 1.9*cs[9] + 2.5*cs[10] + 3.8*cs[11];

  cTBC[3] = 2.0*cs[0] + cs[1] + 0.78*cs[2] + cs[3] + cs[4] + cs[5] + 14.0*cs[6] + cs[7] + 2.0*cs[8] + 1.9*cs[9] + 2.5*cs[10] + 3.8*cs[11];

  cTBC[4] = 2.5*cs[0] + cs[1] + cs[2] + cs[3] + cs[4] + cs[5] + 12.0*cs[6] + cs[7] + 2.0*cs[8] + 1.9*cs[9] + 2.5*cs[10] + 3.8*cs[11];

  cTBC[5] = 2.0*cs[0] + cs[1] + cs[2] + cs[3] + cs[4] + cs[5] + 6.0*cs[6] + cs[7] + 2.0*cs[8] + 1.5*cs[9] + 2.5*cs[10] + 2.0*cs[11];

  cTBC[6] = 2.0*cs[0] + cs[1] + cs[2] + cs[3] + cs[4] + cs[5] + 6.0*cs[6] + cs[7] + 2.0*cs[8] + 1.5*cs[9] + 2.5*cs[10] + 2.0*cs[11];
