...
// --------------------------------------------------------------|
  ...
  double q_f, q_b;
  double q[325];
  q_f =   S_tbc[0] * k_f[0] * pow(cs[2],2.0);
  q_b = - S_tbc[0] * k_f[0]/K_c[0] * cs[3];
  q[0] =   q_f + q_b;

  q_f =   S_tbc[1] * k_f[1] * cs[1] * cs[2];
  q_b = - S_tbc[1] * k_f[1]/K_c[1] * cs[4];
  q[1] =   q_f + q_b;

  q_f =   S_tbc[2] * k_f[2] * cs[0] * cs[2];
  q_b = - S_tbc[2] * k_f[2]/K_c[2] * cs[1] * cs[4];
  q[2] =   q_f + q_b;

  q_f =   S_tbc[3] * k_f[3] * cs[2] * cs[6];
  q_b = - S_tbc[3] * k_f[3]/K_c[3] * cs[3] * cs[4];
  q[3] =   q_f + q_b;

  q_f =   S_tbc[4] * k_f[4] * cs[2] * cs[7];
  q_b = - S_tbc[4] * k_f[4]/K_c[4] * cs[4] * cs[6];
  q[4] =   q_f + q_b;

  q_f =   S_tbc[5] * k_f[5] * cs[2] * cs[9];
  q_b = - S_tbc[5] * k_f[5]/K_c[5] * cs[1] * cs[14];
  q[5] =   q_f + q_b;

  q_f =   S_tbc[6] * k_f[6] * cs[2] * cs[10];
  q_b = - S_tbc[6] * k_f[6]/K_c[6] * cs[1] * cs[16];
  q[6] =   q_f + q_b;

  q_f =   S_tbc[7] * k_f[7] * cs[2] * cs[11];
  q_b = - S_tbc[7] * k_f[7]/K_c[7] * cs[0] * cs[14];
  q[7] =   q_f + q_b;

  q_f =   S_tbc[8] * k_f[8] * cs[2] * cs[11];
  q_b = - S_tbc[8] * k_f[8]/K_c[8] * cs[1] * cs[16];
  q[8] =   q_f + q_b;

  q_f =   S_tbc[9] * k_f[9] * cs[2] * cs[12];
  q_b = - S_tbc[9] * k_f[9]/K_c[9] * cs[1] * cs[17];
  q[9] =   q_f + q_b;

  q_f =   S_tbc[10] * k_f[10] * cs[2] * cs[13];
  q_b = - S_tbc[10] * k_f[10]/K_c[10] * cs[4] * cs[12];
  q[10] =   q_f + q_b;

  q_f =   k_f[11] * cs[2] * cs[14];
  q_b = - k_f[11]/K_c[11] * cs[15];
  q[11] =   q_f + q_b;

  q_f =   S_tbc[12] * k_f[12] * cs[2] * cs[16];
  q_b = - S_tbc[12] * k_f[12]/K_c[12] * cs[4] * cs[14];
  q[12] =   q_f + q_b;

  q_f =   S_tbc[13] * k_f[13] * cs[2] * cs[16];
  q_b = - S_tbc[13] * k_f[13]/K_c[13] * cs[1] * cs[15];
  q[13] =   q_f + q_b;

  q_f =   S_tbc[14] * k_f[14] * cs[2] * cs[17];
  q_b = - S_tbc[14] * k_f[14]/K_c[14] * cs[4] * cs[16];
  q[14] =   q_f + q_b;

  q_f =   S_tbc[15] * k_f[15] * cs[2] * cs[18];
  q_b = - S_tbc[15] * k_f[15]/K_c[15] * cs[4] * cs[17];
  q[15] =   q_f + q_b;

  q_f =   S_tbc[16] * k_f[16] * cs[2] * cs[19];
  q_b = - S_tbc[16] * k_f[16]/K_c[16] * cs[4] * cs[17];
  q[16] =   q_f + q_b;

  q_f =   S_tbc[17] * k_f[17] * cs[2] * cs[20];
  q_b = - S_tbc[17] * k_f[17]/K_c[17] * cs[4] * cs[18];
  q[17] =   q_f + q_b;

  q_f =   S_tbc[18] * k_f[18] * cs[2] * cs[20];
  q_b = - S_tbc[18] * k_f[18]/K_c[18] * cs[4] * cs[19];
  q[18] =   q_f + q_b;

  q_f =   S_tbc[19] * k_f[19] * cs[2] * cs[21];
  q_b = - S_tbc[19] * k_f[19]/K_c[19] * cs[9] * cs[14];
  q[19] =   q_f + q_b;

  q_f =   S_tbc[20] * k_f[20] * cs[2] * cs[22];
  q_b = - S_tbc[20] * k_f[20]/K_c[20] * cs[1] * cs[27];
  q[20] =   q_f + q_b;

  q_f =   S_tbc[21] * k_f[21] * cs[2] * cs[22];
  q_b = - S_tbc[21] * k_f[21]/K_c[21] * cs[4] * cs[21];
  q[21] =   q_f + q_b;

  q_f =   S_tbc[22] * k_f[22] * cs[2] * cs[22];
  q_b = - S_tbc[22] * k_f[22]/K_c[22] * cs[10] * cs[14];
  q[22] =   q_f + q_b;

  q_f =   S_tbc[23] * k_f[23] * cs[2] * cs[23];
  q_b = - S_tbc[23] * k_f[23]/K_c[23] * cs[1] * cs[28];
  q[23] =   q_f + q_b;

  q_f =   S_tbc[24] * k_f[24] * cs[2] * cs[24];
  q_b = - S_tbc[24] * k_f[24]/K_c[24] * cs[12] * cs[16];
  q[24] =   q_f + q_b;

  q_f =   S_tbc[25] * k_f[25] * cs[2] * cs[25];
  q_b = - S_tbc[25] * k_f[25]/K_c[25] * cs[12] * cs[17];
  q[25] =   q_f + q_b;

  q_f =   S_tbc[26] * k_f[26] * cs[2] * cs[26];
  q_b = - S_tbc[26] * k_f[26]/K_c[26] * cs[4] * cs[25];
  q[26] =   q_f + q_b;

  q_f =   S_tbc[27] * k_f[27] * cs[2] * cs[27];
  q_b = - S_tbc[27] * k_f[27]/K_c[27] * cs[1] * pow(cs[14],2.0);
  q[27] =   q_f + q_b;

  q_f =   S_tbc[28] * k_f[28] * cs[2] * cs[28];
  q_b = - S_tbc[28] * k_f[28]/K_c[28] * cs[4] * cs[27];
  q[28] =   q_f + q_b;

  q_f =   S_tbc[29] * k_f[29] * cs[2] * cs[28];
  q_b = - S_tbc[29] * k_f[29]/K_c[29] * cs[10] * cs[15];
  q[29] =   q_f + q_b;

  q_f =   S_tbc[30] * k_f[30] * cs[3] * cs[14];
  q_b = - S_tbc[30] * k_f[30]/K_c[30] * cs[2] * cs[15];
  q[30] =   q_f + q_b;

  q_f =   S_tbc[31] * k_f[31] * cs[3] * cs[17];
  q_b = - S_tbc[31] * k_f[31]/K_c[31] * cs[6] * cs[16];
  q[31] =   q_f + q_b;

  q_f =   S_tbc[32] * k_f[32] * cs[1] * cs[3];
  q_b = - S_tbc[32] * k_f[32]/K_c[32] * cs[6];
  q[32] =   q_f + q_b;

  q_f =   S_tbc[33] * k_f[33] * cs[1] * cs[3];
  q_b = - S_tbc[33] * k_f[33]/K_c[33] * cs[6];
  q[33] =   q_f + q_b;

  q_f =   S_tbc[34] * k_f[34] * cs[1] * cs[3];
  q_b = - S_tbc[34] * k_f[34]/K_c[34] * cs[6];
  q[34] =   q_f + q_b;

  q_f =   S_tbc[35] * k_f[35] * cs[1] * cs[3];
  q_b = - S_tbc[35] * k_f[35]/K_c[35] * cs[6];
  q[35] =   q_f + q_b;

  q_f =   S_tbc[36] * k_f[36] * cs[1] * cs[3];
  q_b = - S_tbc[36] * k_f[36]/K_c[36] * cs[6];
  q[36] =   q_f + q_b;

  q_f =   S_tbc[37] * k_f[37] * cs[1] * cs[3];
  q_b = - S_tbc[37] * k_f[37]/K_c[37] * cs[2] * cs[4];
  q[37] =   q_f + q_b;

  q_f =   S_tbc[38] * k_f[38] * pow(cs[1],2.0);
  q_b = - S_tbc[38] * k_f[38]/K_c[38] * cs[0];
  q[38] =   q_f + q_b;

  q_f =   S_tbc[39] * k_f[39] * pow(cs[1],2.0);
  q_b = - S_tbc[39] * k_f[39]/K_c[39] * cs[0];
  q[39] =   q_f + q_b;

  q_f =   S_tbc[40] * k_f[40] * pow(cs[1],2.0);
  q_b = - S_tbc[40] * k_f[40]/K_c[40] * cs[0];
  q[40] =   q_f + q_b;

  q_f =   S_tbc[41] * k_f[41] * pow(cs[1],2.0);
  q_b = - S_tbc[41] * k_f[41]/K_c[41] * cs[0];
  q[41] =   q_f + q_b;

  q_f =   S_tbc[42] * k_f[42] * cs[1] * cs[4];
  q_b = - S_tbc[42] * k_f[42]/K_c[42] * cs[5];
  q[42] =   q_f + q_b;

  q_f =   S_tbc[43] * k_f[43] * cs[1] * cs[6];
  q_b = - S_tbc[43] * k_f[43]/K_c[43] * cs[2] * cs[5];
  q[43] =   q_f + q_b;

  q_f =   S_tbc[44] * k_f[44] * cs[1] * cs[6];
  q_b = - S_tbc[44] * k_f[44]/K_c[44] * cs[0] * cs[3];
  q[44] =   q_f + q_b;

  q_f =   S_tbc[45] * k_f[45] * cs[1] * cs[6];
  q_b = - S_tbc[45] * k_f[45]/K_c[45] * pow(cs[4],2.0);
  q[45] =   q_f + q_b;

  q_f =   S_tbc[46] * k_f[46] * cs[1] * cs[7];
  q_b = - S_tbc[46] * k_f[46]/K_c[46] * cs[0] * cs[6];
  q[46] =   q_f + q_b;

  q_f =   S_tbc[47] * k_f[47] * cs[1] * cs[7];
  q_b = - S_tbc[47] * k_f[47]/K_c[47] * cs[4] * cs[5];
  q[47] =   q_f + q_b;

  q_f =   S_tbc[48] * k_f[48] * cs[1] * cs[9];
  q_b = - S_tbc[48] * k_f[48]/K_c[48] * cs[0] * cs[8];
  q[48] =   q_f + q_b;

  q_f =   k_f[49] * cs[1] * cs[10];
  q_b = - k_f[49]/K_c[49] * cs[12];
  q[49] =   q_f + q_b;

  q_f =   S_tbc[50] * k_f[50] * cs[1] * cs[11];
  q_b = - S_tbc[50] * k_f[50]/K_c[50] * cs[0] * cs[9];
  q[50] =   q_f + q_b;

  q_f =   k_f[51] * cs[1] * cs[12];
  q_b = - k_f[51]/K_c[51] * cs[13];
  q[51] =   q_f + q_b;

  q_f =   S_tbc[52] * k_f[52] * cs[1] * cs[13];
  q_b = - S_tbc[52] * k_f[52]/K_c[52] * cs[0] * cs[12];
  q[52] =   q_f + q_b;

  q_f =   k_f[53] * cs[1] * cs[16];
  q_b = - k_f[53]/K_c[53] * cs[17];
  q[53] =   q_f + q_b;

  q_f =   S_tbc[54] * k_f[54] * cs[1] * cs[16];
  q_b = - S_tbc[54] * k_f[54]/K_c[54] * cs[0] * cs[14];
  q[54] =   q_f + q_b;

  q_f =   k_f[55] * cs[1] * cs[17];
  q_b = - k_f[55]/K_c[55] * cs[18];
  q[55] =   q_f + q_b;

  q_f =   k_f[56] * cs[1] * cs[17];
  q_b = - k_f[56]/K_c[56] * cs[19];
  q[56] =   q_f + q_b;

  q_f =   S_tbc[57] * k_f[57] * cs[1] * cs[17];
  q_b = - S_tbc[57] * k_f[57]/K_c[57] * cs[0] * cs[16];
  q[57] =   q_f + q_b;

  q_f =   k_f[58] * cs[1] * cs[18];
  q_b = - k_f[58]/K_c[58] * cs[20];
  q[58] =   q_f + q_b;

  q_f =   S_tbc[59] * k_f[59] * cs[1] * cs[18];
  q_b = - S_tbc[59] * k_f[59]/K_c[59] * cs[0] * cs[17];
  q[59] =   q_f + q_b;

  q_f =   S_tbc[60] * k_f[60] * cs[1] * cs[18];
  q_b = - S_tbc[60] * k_f[60]/K_c[60] * cs[4] * cs[12];
  q[60] =   q_f + q_b;

  q_f =   S_tbc[61] * k_f[61] * cs[1] * cs[18];
  q_b = - S_tbc[61] * k_f[61]/K_c[61] * cs[5] * cs[11];
  q[61] =   q_f + q_b;

  q_f =   k_f[62] * cs[1] * cs[19];
  q_b = - k_f[62]/K_c[62] * cs[20];
  q[62] =   q_f + q_b;

  q_f =   S_tbc[63] * k_f[63] * cs[1] * cs[19];
  q_b = - S_tbc[63] * k_f[63]/K_c[63] * cs[1] * cs[18];
  q[63] =   q_f + q_b;

  q_f =   S_tbc[64] * k_f[64] * cs[1] * cs[19];
  q_b = - S_tbc[64] * k_f[64]/K_c[64] * cs[0] * cs[17];
  q[64] =   q_f + q_b;

  q_f =   S_tbc[65] * k_f[65] * cs[1] * cs[19];
  q_b = - S_tbc[65] * k_f[65]/K_c[65] * cs[4] * cs[12];
  q[65] =   q_f + q_b;

  q_f =   S_tbc[66] * k_f[66] * cs[1] * cs[19];
  q_b = - S_tbc[66] * k_f[66]/K_c[66] * cs[5] * cs[11];
  q[66] =   q_f + q_b;

  q_f =   S_tbc[67] * k_f[67] * cs[1] * cs[20];
  q_b = - S_tbc[67] * k_f[67]/K_c[67] * cs[0] * cs[18];
  q[67] =   q_f + q_b;

  q_f =   S_tbc[68] * k_f[68] * cs[1] * cs[20];
  q_b = - S_tbc[68] * k_f[68]/K_c[68] * cs[0] * cs[19];
  q[68] =   q_f + q_b;

  q_f =   k_f[69] * cs[1] * cs[21];
  q_b = - k_f[69]/K_c[69] * cs[22];
  q[69] =   q_f + q_b;

  q_f =   k_f[70] * cs[1] * cs[22];
  q_b = - k_f[70]/K_c[70] * cs[23];
  q[70] =   q_f + q_b;

  q_f =   k_f[71] * cs[1] * cs[23];
  q_b = - k_f[71]/K_c[71] * cs[24];
  q[71] =   q_f + q_b;

  q_f =   S_tbc[72] * k_f[72] * cs[1] * cs[23];
  q_b = - S_tbc[72] * k_f[72]/K_c[72] * cs[0] * cs[22];
  q[72] =   q_f + q_b;

  q_f =   k_f[73] * cs[1] * cs[24];
  q_b = - k_f[73]/K_c[73] * cs[25];
  q[73] =   q_f + q_b;

  q_f =   S_tbc[74] * k_f[74] * cs[1] * cs[24];
  q_b = - S_tbc[74] * k_f[74]/K_c[74] * cs[0] * cs[23];
  q[74] =   q_f + q_b;

  q_f =   k_f[75] * cs[1] * cs[25];
  q_b = - k_f[75]/K_c[75] * cs[26];
  q[75] =   q_f + q_b;

  q_f =   S_tbc[76] * k_f[76] * cs[1] * cs[25];
  q_b = - S_tbc[76] * k_f[76]/K_c[76] * cs[0] * cs[24];
  q[76] =   q_f + q_b;

  q_f =   S_tbc[77] * k_f[77] * cs[1] * cs[26];
  q_b = - S_tbc[77] * k_f[77]/K_c[77] * cs[0] * cs[25];
  q[77] =   q_f + q_b;

  q_f =   S_tbc[78] * k_f[78] * cs[1] * cs[27];
  q_b = - S_tbc[78] * k_f[78]/K_c[78] * cs[11] * cs[14];
  q[78] =   q_f + q_b;

  q_f =   S_tbc[79] * k_f[79] * cs[1] * cs[28];
  q_b = - S_tbc[79] * k_f[79]/K_c[79] * cs[0] * cs[27];
  q[79] =   q_f + q_b;

  q_f =   S_tbc[80] * k_f[80] * cs[1] * cs[28];
  q_b = - S_tbc[80] * k_f[80]/K_c[80] * cs[12] * cs[14];
  q[80] =   q_f + q_b;

  q_f =   S_tbc[81] * k_f[81] * cs[1] * cs[29];
  q_b = - S_tbc[81] * k_f[81]/K_c[81] * cs[1] * cs[28];
  q[81] =   q_f + q_b;

  q_f =   k_f[82] * cs[0] * cs[14];
  q_b = - k_f[82]/K_c[82] * cs[17];
  q[82] =   q_f + q_b;

  q_f =   S_tbc[83] * k_f[83] * cs[0] * cs[4];
  q_b = - S_tbc[83] * k_f[83]/K_c[83] * cs[1] * cs[5];
  q[83] =   q_f + q_b;

  q_f =   k_f[84] * pow(cs[4],2.0);
  q_b = - k_f[84]/K_c[84] * cs[7];
  q[84] =   q_f + q_b;

  q_f =   S_tbc[85] * k_f[85] * pow(cs[4],2.0);
  q_b = - S_tbc[85] * k_f[85]/K_c[85] * cs[2] * cs[5];
  q[85] =   q_f + q_b;

  q_f =   S_tbc[86] * k_f[86] * cs[4] * cs[6];
  q_b = - S_tbc[86] * k_f[86]/K_c[86] * cs[3] * cs[5];
  q[86] =   q_f + q_b;

  q_f =   S_tbc[87] * k_f[87] * cs[4] * cs[7];
  q_b = - S_tbc[87] * k_f[87]/K_c[87] * cs[5] * cs[6];
  q[87] =   q_f + q_b;

  q_f =   S_tbc[88] * k_f[88] * cs[4] * cs[7];
  q_b = - S_tbc[88] * k_f[88]/K_c[88] * cs[5] * cs[6];
  q[88] =   q_f + q_b;

  q_f =   S_tbc[89] * k_f[89] * cs[4] * cs[8];
  q_b = - S_tbc[89] * k_f[89]/K_c[89] * cs[1] * cs[14];
  q[89] =   q_f + q_b;

  q_f =   S_tbc[90] * k_f[90] * cs[4] * cs[9];
  q_b = - S_tbc[90] * k_f[90]/K_c[90] * cs[1] * cs[16];
  q[90] =   q_f + q_b;

  q_f =   S_tbc[91] * k_f[91] * cs[4] * cs[10];
  q_b = - S_tbc[91] * k_f[91]/K_c[91] * cs[1] * cs[17];
  q[91] =   q_f + q_b;

  q_f =   S_tbc[92] * k_f[92] * cs[4] * cs[10];
  q_b = - S_tbc[92] * k_f[92]/K_c[92] * cs[5] * cs[9];
  q[92] =   q_f + q_b;

  q_f =   S_tbc[93] * k_f[93] * cs[4] * cs[11];
  q_b = - S_tbc[93] * k_f[93]/K_c[93] * cs[1] * cs[17];
  q[93] =   q_f + q_b;

  q_f =   k_f[94] * cs[4] * cs[12];
  q_b = - k_f[94]/K_c[94] * cs[20];
  q[94] =   q_f + q_b;

  q_f =   S_tbc[95] * k_f[95] * cs[4] * cs[12];
  q_b = - S_tbc[95] * k_f[95]/K_c[95] * cs[5] * cs[10];
  q[95] =   q_f + q_b;

  q_f =   S_tbc[96] * k_f[96] * cs[4] * cs[12];
  q_b = - S_tbc[96] * k_f[96]/K_c[96] * cs[5] * cs[11];
  q[96] =   q_f + q_b;

  q_f =   S_tbc[97] * k_f[97] * cs[4] * cs[13];
  q_b = - S_tbc[97] * k_f[97]/K_c[97] * cs[5] * cs[12];
  q[97] =   q_f + q_b;

  q_f =   S_tbc[98] * k_f[98] * cs[4] * cs[14];
  q_b = - S_tbc[98] * k_f[98]/K_c[98] * cs[1] * cs[15];
  q[98] =   q_f + q_b;

  q_f =   S_tbc[99] * k_f[99] * cs[4] * cs[16];
  q_b = - S_tbc[99] * k_f[99]/K_c[99] * cs[5] * cs[14];
  q[99] =   q_f + q_b;

  q_f =   S_tbc[100] * k_f[100] * cs[4] * cs[17];
  q_b = - S_tbc[100] * k_f[100]/K_c[100] * cs[5] * cs[16];
  q[100] =   q_f + q_b;

  q_f =   S_tbc[101] * k_f[101] * cs[4] * cs[18];
  q_b = - S_tbc[101] * k_f[101]/K_c[101] * cs[5] * cs[17];
  q[101] =   q_f + q_b;

  q_f =   S_tbc[102] * k_f[102] * cs[4] * cs[19];
  q_b = - S_tbc[102] * k_f[102]/K_c[102] * cs[5] * cs[17];
  q[102] =   q_f + q_b;

  q_f =   S_tbc[103] * k_f[103] * cs[4] * cs[20];
  q_b = - S_tbc[103] * k_f[103]/K_c[103] * cs[5] * cs[18];
  q[103] =   q_f + q_b;

  q_f =   S_tbc[104] * k_f[104] * cs[4] * cs[20];
  q_b = - S_tbc[104] * k_f[104]/K_c[104] * cs[5] * cs[19];
  q[104] =   q_f + q_b;

  q_f =   S_tbc[105] * k_f[105] * cs[4] * cs[21];
  q_b = - S_tbc[105] * k_f[105]/K_c[105] * cs[1] * cs[27];
  q[105] =   q_f + q_b;

  q_f =   S_tbc[106] * k_f[106] * cs[4] * cs[22];
  q_b = - S_tbc[106] * k_f[106]/K_c[106] * cs[1] * cs[28];
  q[106] =   q_f + q_b;

  q_f =   S_tbc[107] * k_f[107] * cs[4] * cs[22];
  q_b = - S_tbc[107] * k_f[107]/K_c[107] * cs[1] * cs[29];
  q[107] =   q_f + q_b;

  q_f =   S_tbc[108] * k_f[108] * cs[4] * cs[22];
  q_b = - S_tbc[108] * k_f[108]/K_c[108] * cs[5] * cs[21];
  q[108] =   q_f + q_b;

  q_f =   S_tbc[109] * k_f[109] * cs[4] * cs[22];
  q_b = - S_tbc[109] * k_f[109]/K_c[109] * cs[12] * cs[14];
  q[109] =   q_f + q_b;

  q_f =   S_tbc[110] * k_f[110] * cs[4] * cs[23];
  q_b = - S_tbc[110] * k_f[110]/K_c[110] * cs[5] * cs[22];
  q[110] =   q_f + q_b;

  q_f =   S_tbc[111] * k_f[111] * cs[4] * cs[24];
  q_b = - S_tbc[111] * k_f[111]/K_c[111] * cs[5] * cs[23];
  q[111] =   q_f + q_b;

  q_f =   S_tbc[112] * k_f[112] * cs[4] * cs[26];
  q_b = - S_tbc[112] * k_f[112]/K_c[112] * cs[5] * cs[25];
  q[112] =   q_f + q_b;

  q_f =   S_tbc[113] * k_f[113] * cs[4] * cs[28];
  q_b = - S_tbc[113] * k_f[113]/K_c[113] * cs[5] * cs[27];
  q[113] =   q_f + q_b;

  q_f =   S_tbc[114] * k_f[114] * pow(cs[6],2.0);
  q_b = - S_tbc[114] * k_f[114]/K_c[114] * cs[3] * cs[7];
  q[114] =   q_f + q_b;

  q_f =   S_tbc[115] * k_f[115] * pow(cs[6],2.0);
  q_b = - S_tbc[115] * k_f[115]/K_c[115] * cs[3] * cs[7];
  q[115] =   q_f + q_b;

  q_f =   S_tbc[116] * k_f[116] * cs[6] * cs[10];
  q_b = - S_tbc[116] * k_f[116]/K_c[116] * cs[4] * cs[17];
  q[116] =   q_f + q_b;

  q_f =   S_tbc[117] * k_f[117] * cs[6] * cs[12];
  q_b = - S_tbc[117] * k_f[117]/K_c[117] * cs[3] * cs[13];
  q[117] =   q_f + q_b;

  q_f =   S_tbc[118] * k_f[118] * cs[6] * cs[12];
  q_b = - S_tbc[118] * k_f[118]/K_c[118] * cs[4] * cs[19];
  q[118] =   q_f + q_b;

  q_f =   S_tbc[119] * k_f[119] * cs[6] * cs[14];
  q_b = - S_tbc[119] * k_f[119]/K_c[119] * cs[4] * cs[15];
  q[119] =   q_f + q_b;

  q_f =   S_tbc[120] * k_f[120] * cs[6] * cs[17];
  q_b = - S_tbc[120] * k_f[120]/K_c[120] * cs[7] * cs[16];
  q[120] =   q_f + q_b;

  q_f =   S_tbc[121] * k_f[121] * cs[3] * cs[8];
  q_b = - S_tbc[121] * k_f[121]/K_c[121] * cs[2] * cs[14];
  q[121] =   q_f + q_b;

  q_f =   S_tbc[122] * k_f[122] * cs[8] * cs[10];
  q_b = - S_tbc[122] * k_f[122]/K_c[122] * cs[1] * cs[21];
  q[122] =   q_f + q_b;

  q_f =   S_tbc[123] * k_f[123] * cs[8] * cs[12];
  q_b = - S_tbc[123] * k_f[123]/K_c[123] * cs[1] * cs[22];
  q[123] =   q_f + q_b;

  q_f =   S_tbc[124] * k_f[124] * cs[3] * cs[9];
  q_b = - S_tbc[124] * k_f[124]/K_c[124] * cs[2] * cs[16];
  q[124] =   q_f + q_b;

  q_f =   S_tbc[125] * k_f[125] * cs[0] * cs[9];
  q_b = - S_tbc[125] * k_f[125]/K_c[125] * cs[1] * cs[10];
  q[125] =   q_f + q_b;

  q_f =   S_tbc[126] * k_f[126] * cs[5] * cs[9];
  q_b = - S_tbc[126] * k_f[126]/K_c[126] * cs[1] * cs[17];
  q[126] =   q_f + q_b;

  q_f =   S_tbc[127] * k_f[127] * cs[9] * cs[10];
  q_b = - S_tbc[127] * k_f[127]/K_c[127] * cs[1] * cs[22];
  q[127] =   q_f + q_b;

  q_f =   S_tbc[128] * k_f[128] * cs[9] * cs[12];
  q_b = - S_tbc[128] * k_f[128]/K_c[128] * cs[1] * cs[23];
  q[128] =   q_f + q_b;

  q_f =   S_tbc[129] * k_f[129] * cs[9] * cs[13];
  q_b = - S_tbc[129] * k_f[129]/K_c[129] * cs[1] * cs[24];
  q[129] =   q_f + q_b;

  q_f =   k_f[130] * cs[9] * cs[14];
  q_b = - k_f[130]/K_c[130] * cs[27];
  q[130] =   q_f + q_b;

  q_f =   S_tbc[131] * k_f[131] * cs[9] * cs[15];
  q_b = - S_tbc[131] * k_f[131]/K_c[131] * cs[14] * cs[16];
  q[131] =   q_f + q_b;

  q_f =   S_tbc[132] * k_f[132] * cs[9] * cs[17];
  q_b = - S_tbc[132] * k_f[132]/K_c[132] * cs[1] * cs[28];
  q[132] =   q_f + q_b;

  q_f =   S_tbc[133] * k_f[133] * cs[9] * cs[27];
  q_b = - S_tbc[133] * k_f[133]/K_c[133] * cs[14] * cs[22];
  q[133] =   q_f + q_b;

  q_f =   S_tbc[134] * k_f[134] * cs[3] * cs[10];
  q_b = - S_tbc[134] * k_f[134]/K_c[134] * cs[1] * cs[4] * cs[14];
  q[134] =   q_f;

  q_f =   S_tbc[135] * k_f[135] * cs[0] * cs[10];
  q_b = - S_tbc[135] * k_f[135]/K_c[135] * cs[1] * cs[12];
  q[135] =   q_f + q_b;

  q_f =   S_tbc[136] * k_f[136] * pow(cs[10],2.0);
  q_b = - S_tbc[136] * k_f[136]/K_c[136] * cs[0] * cs[22];
  q[136] =   q_f + q_b;

  q_f =   S_tbc[137] * k_f[137] * cs[10] * cs[12];
  q_b = - S_tbc[137] * k_f[137]/K_c[137] * cs[1] * cs[24];
  q[137] =   q_f + q_b;

  q_f =   S_tbc[138] * k_f[138] * cs[10] * cs[13];
  q_b = - S_tbc[138] * k_f[138]/K_c[138] * pow(cs[12],2.0);
  q[138] =   q_f + q_b;

  q_f =   k_f[139] * cs[10] * cs[14];
  q_b = - k_f[139]/K_c[139] * cs[28];
  q[139] =   q_f + q_b;

  q_f =   S_tbc[140] * k_f[140] * cs[10] * cs[27];
  q_b = - S_tbc[140] * k_f[140]/K_c[140] * cs[14] * cs[23];
  q[140] =   q_f + q_b;

  q_f =   S_tbc[141] * k_f[141] * cs[11] * cs[47];
  q_b = - S_tbc[141] * k_f[141]/K_c[141] * cs[10] * cs[47];
  q[141] =   q_f + q_b;

  q_f =   S_tbc[142] * k_f[142] * cs[11] * cs[48];
  q_b = - S_tbc[142] * k_f[142]/K_c[142] * cs[10] * cs[48];
  q[142] =   q_f + q_b;

  q_f =   S_tbc[143] * k_f[143] * cs[3] * cs[11];
  q_b = - S_tbc[143] * k_f[143]/K_c[143] * cs[1] * cs[4] * cs[14];
  q[143] =   q_f + q_b;

  q_f =   S_tbc[144] * k_f[144] * cs[3] * cs[11];
  q_b = - S_tbc[144] * k_f[144]/K_c[144] * cs[5] * cs[14];
  q[144] =   q_f + q_b;

  q_f =   S_tbc[145] * k_f[145] * cs[0] * cs[11];
  q_b = - S_tbc[145] * k_f[145]/K_c[145] * cs[1] * cs[12];
  q[145] =   q_f + q_b;

  q_f =   k_f[146] * cs[5] * cs[11];
  q_b = - k_f[146]/K_c[146] * cs[20];
  q[146] =   q_f + q_b;

  q_f =   S_tbc[147] * k_f[147] * cs[5] * cs[11];
  q_b = - S_tbc[147] * k_f[147]/K_c[147] * cs[5] * cs[10];
  q[147] =   q_f + q_b;

  q_f =   S_tbc[148] * k_f[148] * cs[11] * cs[12];
  q_b = - S_tbc[148] * k_f[148]/K_c[148] * cs[1] * cs[24];
  q[148] =   q_f + q_b;

  q_f =   S_tbc[149] * k_f[149] * cs[11] * cs[13];
  q_b = - S_tbc[149] * k_f[149]/K_c[149] * pow(cs[12],2.0);
  q[149] =   q_f + q_b;

  q_f =   S_tbc[150] * k_f[150] * cs[11] * cs[14];
  q_b = - S_tbc[150] * k_f[150]/K_c[150] * cs[10] * cs[14];
  q[150] =   q_f + q_b;

  q_f =   S_tbc[151] * k_f[151] * cs[11] * cs[15];
  q_b = - S_tbc[151] * k_f[151]/K_c[151] * cs[10] * cs[15];
  q[151] =   q_f + q_b;

  q_f =   S_tbc[152] * k_f[152] * cs[11] * cs[15];
  q_b = - S_tbc[152] * k_f[152]/K_c[152] * cs[14] * cs[17];
  q[152] =   q_f + q_b;

  q_f =   S_tbc[153] * k_f[153] * cs[11] * cs[26];
  q_b = - S_tbc[153] * k_f[153]/K_c[153] * cs[12] * cs[25];
  q[153] =   q_f + q_b;

  q_f =   S_tbc[154] * k_f[154] * cs[3] * cs[12];
  q_b = - S_tbc[154] * k_f[154]/K_c[154] * cs[2] * cs[19];
  q[154] =   q_f + q_b;

  q_f =   S_tbc[155] * k_f[155] * cs[3] * cs[12];
  q_b = - S_tbc[155] * k_f[155]/K_c[155] * cs[4] * cs[17];
  q[155] =   q_f + q_b;

  q_f =   S_tbc[156] * k_f[156] * cs[7] * cs[12];
  q_b = - S_tbc[156] * k_f[156]/K_c[156] * cs[6] * cs[13];
  q[156] =   q_f + q_b;

  q_f =   k_f[157] * pow(cs[12],2.0);
  q_b = - k_f[157]/K_c[157] * cs[26];
  q[157] =   q_f + q_b;

  q_f =   S_tbc[158] * k_f[158] * pow(cs[12],2.0);
  q_b = - S_tbc[158] * k_f[158]/K_c[158] * cs[1] * cs[25];
  q[158] =   q_f + q_b;

  q_f =   S_tbc[159] * k_f[159] * cs[12] * cs[16];
  q_b = - S_tbc[159] * k_f[159]/K_c[159] * cs[13] * cs[14];
  q[159] =   q_f + q_b;

  q_f =   S_tbc[160] * k_f[160] * cs[12] * cs[17];
  q_b = - S_tbc[160] * k_f[160]/K_c[160] * cs[13] * cs[16];
  q[160] =   q_f + q_b;

  q_f =   S_tbc[161] * k_f[161] * cs[12] * cs[20];
  q_b = - S_tbc[161] * k_f[161]/K_c[161] * cs[13] * cs[18];
  q[161] =   q_f + q_b;

  q_f =   S_tbc[162] * k_f[162] * cs[12] * cs[20];
  q_b = - S_tbc[162] * k_f[162]/K_c[162] * cs[13] * cs[19];
  q[162] =   q_f + q_b;

  q_f =   S_tbc[163] * k_f[163] * cs[12] * cs[24];
  q_b = - S_tbc[163] * k_f[163]/K_c[163] * cs[13] * cs[23];
  q[163] =   q_f + q_b;

  q_f =   S_tbc[164] * k_f[164] * cs[12] * cs[26];
  q_b = - S_tbc[164] * k_f[164]/K_c[164] * cs[13] * cs[25];
  q[164] =   q_f + q_b;

  q_f =   S_tbc[165] * k_f[165] * cs[16];
  q_b = - S_tbc[165] * k_f[165]/K_c[165] * cs[1] * cs[14];
  q[165] =   q_f + q_b;

  q_f =   S_tbc[166] * k_f[166] * cs[16];
  q_b = - S_tbc[166] * k_f[166]/K_c[166] * cs[1] * cs[14];
  q[166] =   q_f + q_b;

  q_f =   S_tbc[167] * k_f[167] * cs[3] * cs[16];
  q_b = - S_tbc[167] * k_f[167]/K_c[167] * cs[6] * cs[14];
  q[167] =   q_f + q_b;

  q_f =   S_tbc[168] * k_f[168] * cs[3] * cs[18];
  q_b = - S_tbc[168] * k_f[168]/K_c[168] * cs[6] * cs[17];
  q[168] =   q_f + q_b;

  q_f =   S_tbc[169] * k_f[169] * cs[3] * cs[19];
  q_b = - S_tbc[169] * k_f[169]/K_c[169] * cs[6] * cs[17];
  q[169] =   q_f + q_b;

  q_f =   S_tbc[170] * k_f[170] * cs[3] * cs[21];
  q_b = - S_tbc[170] * k_f[170]/K_c[170] * cs[14] * cs[16];
  q[170] =   q_f + q_b;

  q_f =   S_tbc[171] * k_f[171] * cs[0] * cs[21];
  q_b = - S_tbc[171] * k_f[171]/K_c[171] * cs[1] * cs[22];
  q[171] =   q_f + q_b;

  q_f =   S_tbc[172] * k_f[172] * cs[3] * cs[23];
  q_b = - S_tbc[172] * k_f[172]/K_c[172] * cs[16] * cs[17];
  q[172] =   q_f + q_b;

  q_f =   k_f[173] * cs[24];
  q_b = - k_f[173]/K_c[173] * cs[0] * cs[22];
  q[173] =   q_f + q_b;

  q_f =   S_tbc[174] * k_f[174] * cs[3] * cs[25];
  q_b = - S_tbc[174] * k_f[174]/K_c[174] * cs[6] * cs[24];
  q[174] =   q_f + q_b;

  q_f =   S_tbc[175] * k_f[175] * cs[3] * cs[27];
  q_b = - S_tbc[175] * k_f[175]/K_c[175] * cs[4] * pow(cs[14],2.0);
  q[175] =   q_f + q_b;

  q_f =   S_tbc[176] * k_f[176] * pow(cs[27],2.0);
  q_b = - S_tbc[176] * k_f[176]/K_c[176] * pow(cs[14],2.0) * cs[22];
  q[176] =   q_f + q_b;

  q_f =   S_tbc[177] * k_f[177] * cs[30] * cs[35];
  q_b = - S_tbc[177] * k_f[177]/K_c[177] * cs[2] * cs[47];
  q[177] =   q_f + q_b;

  q_f =   S_tbc[178] * k_f[178] * cs[3] * cs[30];
  q_b = - S_tbc[178] * k_f[178]/K_c[178] * cs[2] * cs[35];
  q[178] =   q_f + q_b;

  q_f =   S_tbc[179] * k_f[179] * cs[4] * cs[30];
  q_b = - S_tbc[179] * k_f[179]/K_c[179] * cs[1] * cs[35];
  q[179] =   q_f + q_b;

  q_f =   S_tbc[180] * k_f[180] * cs[2] * cs[37];
  q_b = - S_tbc[180] * k_f[180]/K_c[180] * cs[3] * cs[47];
  q[180] =   q_f + q_b;

  q_f =   S_tbc[181] * k_f[181] * cs[2] * cs[37];
  q_b = - S_tbc[181] * k_f[181]/K_c[181] * pow(cs[35],2.0);
  q[181] =   q_f + q_b;

  q_f =   S_tbc[182] * k_f[182] * cs[1] * cs[37];
  q_b = - S_tbc[182] * k_f[182]/K_c[182] * cs[4] * cs[47];
  q[182] =   q_f + q_b;

  q_f =   S_tbc[183] * k_f[183] * cs[4] * cs[37];
  q_b = - S_tbc[183] * k_f[183]/K_c[183] * cs[6] * cs[47];
  q[183] =   q_f + q_b;

  q_f =   k_f[184] * cs[37];
  q_b = - k_f[184]/K_c[184] * cs[2] * cs[47];
  q[184] =   q_f + q_b;

  q_f =   S_tbc[185] * k_f[185] * cs[6] * cs[35];
  q_b = - S_tbc[185] * k_f[185]/K_c[185] * cs[4] * cs[36];
  q[185] =   q_f + q_b;

  q_f =   S_tbc[186] * k_f[186] * cs[2] * cs[35];
  q_b = - S_tbc[186] * k_f[186]/K_c[186] * cs[36];
  q[186] =   q_f + q_b;

  q_f =   S_tbc[187] * k_f[187] * cs[2] * cs[36];
  q_b = - S_tbc[187] * k_f[187]/K_c[187] * cs[3] * cs[35];
  q[187] =   q_f + q_b;

  q_f =   S_tbc[188] * k_f[188] * cs[1] * cs[36];
  q_b = - S_tbc[188] * k_f[188]/K_c[188] * cs[4] * cs[35];
  q[188] =   q_f + q_b;

  q_f =   S_tbc[189] * k_f[189] * cs[2] * cs[31];
  q_b = - S_tbc[189] * k_f[189]/K_c[189] * cs[1] * cs[35];
  q[189] =   q_f + q_b;

  q_f =   S_tbc[190] * k_f[190] * cs[1] * cs[31];
  q_b = - S_tbc[190] * k_f[190]/K_c[190] * cs[0] * cs[30];
  q[190] =   q_f + q_b;

  q_f =   S_tbc[191] * k_f[191] * cs[4] * cs[31];
  q_b = - S_tbc[191] * k_f[191]/K_c[191] * cs[1] * cs[38];
  q[191] =   q_f + q_b;

  q_f =   S_tbc[192] * k_f[192] * cs[4] * cs[31];
  q_b = - S_tbc[192] * k_f[192]/K_c[192] * cs[5] * cs[30];
  q[192] =   q_f + q_b;

  q_f =   S_tbc[193] * k_f[193] * cs[3] * cs[31];
  q_b = - S_tbc[193] * k_f[193]/K_c[193] * cs[2] * cs[38];
  q[193] =   q_f + q_b;

  q_f =   S_tbc[194] * k_f[194] * cs[3] * cs[31];
  q_b = - S_tbc[194] * k_f[194]/K_c[194] * cs[4] * cs[35];
  q[194] =   q_f + q_b;

  q_f =   S_tbc[195] * k_f[195] * cs[30] * cs[31];
  q_b = - S_tbc[195] * k_f[195]/K_c[195] * cs[1] * cs[47];
  q[195] =   q_f + q_b;

  q_f =   S_tbc[196] * k_f[196] * cs[5] * cs[31];
  q_b = - S_tbc[196] * k_f[196]/K_c[196] * cs[0] * cs[38];
  q[196] =   q_f + q_b;

  q_f =   S_tbc[197] * k_f[197] * cs[31] * cs[35];
  q_b = - S_tbc[197] * k_f[197]/K_c[197] * cs[4] * cs[47];
  q[197] =   q_f + q_b;

  q_f =   S_tbc[198] * k_f[198] * cs[31] * cs[35];
  q_b = - S_tbc[198] * k_f[198]/K_c[198] * cs[1] * cs[37];
  q[198] =   q_f + q_b;

  q_f =   S_tbc[199] * k_f[199] * cs[2] * cs[32];
  q_b = - S_tbc[199] * k_f[199]/K_c[199] * cs[4] * cs[31];
  q[199] =   q_f + q_b;

  q_f =   S_tbc[200] * k_f[200] * cs[2] * cs[32];
  q_b = - S_tbc[200] * k_f[200]/K_c[200] * cs[1] * cs[38];
  q[200] =   q_f + q_b;

  q_f =   S_tbc[201] * k_f[201] * cs[1] * cs[32];
  q_b = - S_tbc[201] * k_f[201]/K_c[201] * cs[0] * cs[31];
  q[201] =   q_f + q_b;

  q_f =   S_tbc[202] * k_f[202] * cs[4] * cs[32];
  q_b = - S_tbc[202] * k_f[202]/K_c[202] * cs[5] * cs[31];
  q[202] =   q_f + q_b;

  q_f =   S_tbc[203] * k_f[203] * cs[34];
  q_b = - S_tbc[203] * k_f[203]/K_c[203] * cs[1] * cs[47];
  q[203] =   q_f + q_b;

  q_f =   S_tbc[204] * k_f[204] * cs[34];
  q_b = - S_tbc[204] * k_f[204]/K_c[204] * cs[1] * cs[47];
  q[204] =   q_f + q_b;

  q_f =   S_tbc[205] * k_f[205] * cs[3] * cs[34];
  q_b = - S_tbc[205] * k_f[205]/K_c[205] * cs[6] * cs[47];
  q[205] =   q_f + q_b;

  q_f =   S_tbc[206] * k_f[206] * cs[2] * cs[34];
  q_b = - S_tbc[206] * k_f[206]/K_c[206] * cs[4] * cs[47];
  q[206] =   q_f + q_b;

  q_f =   S_tbc[207] * k_f[207] * cs[2] * cs[34];
  q_b = - S_tbc[207] * k_f[207]/K_c[207] * cs[31] * cs[35];
  q[207] =   q_f + q_b;

  q_f =   S_tbc[208] * k_f[208] * cs[1] * cs[34];
  q_b = - S_tbc[208] * k_f[208]/K_c[208] * cs[0] * cs[47];
  q[208] =   q_f + q_b;

  q_f =   S_tbc[209] * k_f[209] * cs[4] * cs[34];
  q_b = - S_tbc[209] * k_f[209]/K_c[209] * cs[5] * cs[47];
  q[209] =   q_f + q_b;

  q_f =   S_tbc[210] * k_f[210] * cs[12] * cs[34];
  q_b = - S_tbc[210] * k_f[210]/K_c[210] * cs[13] * cs[47];
  q[210] =   q_f + q_b;

  q_f =   S_tbc[211] * k_f[211] * cs[1] * cs[35];
  q_b = - S_tbc[211] * k_f[211]/K_c[211] * cs[38];
  q[211] =   q_f + q_b;

  q_f =   S_tbc[212] * k_f[212] * cs[2] * cs[38];
  q_b = - S_tbc[212] * k_f[212]/K_c[212] * cs[4] * cs[35];
  q[212] =   q_f + q_b;

  q_f =   S_tbc[213] * k_f[213] * cs[1] * cs[38];
  q_b = - S_tbc[213] * k_f[213]/K_c[213] * cs[0] * cs[35];
  q[213] =   q_f + q_b;

  q_f =   S_tbc[214] * k_f[214] * cs[4] * cs[38];
  q_b = - S_tbc[214] * k_f[214]/K_c[214] * cs[5] * cs[35];
  q[214] =   q_f + q_b;

  q_f =   S_tbc[215] * k_f[215] * cs[3] * cs[38];
  q_b = - S_tbc[215] * k_f[215]/K_c[215] * cs[6] * cs[35];
  q[215] =   q_f + q_b;

  q_f =   S_tbc[216] * k_f[216] * cs[2] * cs[39];
  q_b = - S_tbc[216] * k_f[216]/K_c[216] * cs[14] * cs[30];
  q[216] =   q_f + q_b;

  q_f =   S_tbc[217] * k_f[217] * cs[4] * cs[39];
  q_b = - S_tbc[217] * k_f[217]/K_c[217] * cs[1] * cs[46];
  q[217] =   q_f + q_b;

  q_f =   S_tbc[218] * k_f[218] * cs[5] * cs[39];
  q_b = - S_tbc[218] * k_f[218]/K_c[218] * cs[4] * cs[40];
  q[218] =   q_f + q_b;

  q_f =   S_tbc[219] * k_f[219] * cs[3] * cs[39];
  q_b = - S_tbc[219] * k_f[219]/K_c[219] * cs[2] * cs[46];
  q[219] =   q_f + q_b;

  q_f =   S_tbc[220] * k_f[220] * cs[0] * cs[39];
  q_b = - S_tbc[220] * k_f[220]/K_c[220] * cs[1] * cs[40];
  q[220] =   q_f + q_b;

  q_f =   S_tbc[221] * k_f[221] * cs[2] * cs[46];
  q_b = - S_tbc[221] * k_f[221]/K_c[221] * cs[14] * cs[35];
  q[221] =   q_f + q_b;

  q_f =   S_tbc[222] * k_f[222] * cs[1] * cs[46];
  q_b = - S_tbc[222] * k_f[222]/K_c[222] * cs[14] * cs[31];
  q[222] =   q_f + q_b;

  q_f =   S_tbc[223] * k_f[223] * cs[4] * cs[46];
  q_b = - S_tbc[223] * k_f[223]/K_c[223] * cs[1] * cs[14] * cs[35];
  q[223] =   q_f + q_b;

  q_f =   S_tbc[224] * k_f[224] * cs[30] * cs[46];
  q_b = - S_tbc[224] * k_f[224]/K_c[224] * cs[14] * cs[47];
  q[224] =   q_f + q_b;

  q_f =   S_tbc[225] * k_f[225] * cs[3] * cs[46];
  q_b = - S_tbc[225] * k_f[225]/K_c[225] * cs[15] * cs[35];
  q[225] =   q_f + q_b;

  q_f =   S_tbc[226] * k_f[226] * cs[46];
  q_b = - S_tbc[226] * k_f[226]/K_c[226] * cs[14] * cs[30];
  q[226] =   q_f + q_b;

  q_f =   S_tbc[227] * k_f[227] * cs[35] * cs[46];
  q_b = - S_tbc[227] * k_f[227]/K_c[227] * cs[14] * cs[37];
  q[227] =   q_f + q_b;

  q_f =   S_tbc[228] * k_f[228] * cs[35] * cs[46];
  q_b = - S_tbc[228] * k_f[228]/K_c[228] * cs[15] * cs[47];
  q[228] =   q_f + q_b;

  q_f =   S_tbc[229] * k_f[229] * cs[40];
  q_b = - S_tbc[229] * k_f[229]/K_c[229] * cs[1] * cs[39];
  q[229] =   q_f + q_b;

  q_f =   S_tbc[230] * k_f[230] * cs[2] * cs[40];
  q_b = - S_tbc[230] * k_f[230]/K_c[230] * cs[1] * cs[46];
  q[230] =   q_f + q_b;

  q_f =   S_tbc[231] * k_f[231] * cs[2] * cs[40];
  q_b = - S_tbc[231] * k_f[231]/K_c[231] * cs[14] * cs[31];
  q[231] =   q_f + q_b;

  q_f =   S_tbc[232] * k_f[232] * cs[2] * cs[40];
  q_b = - S_tbc[232] * k_f[232]/K_c[232] * cs[4] * cs[39];
  q[232] =   q_f + q_b;

  q_f =   S_tbc[233] * k_f[233] * cs[4] * cs[40];
  q_b = - S_tbc[233] * k_f[233]/K_c[233] * cs[1] * cs[44];
  q[233] =   q_f + q_b;

  q_f =   S_tbc[234] * k_f[234] * cs[4] * cs[40];
  q_b = - S_tbc[234] * k_f[234]/K_c[234] * cs[1] * cs[45];
  q[234] =   q_f + q_b;

  q_f =   S_tbc[235] * k_f[235] * cs[4] * cs[40];
  q_b = - S_tbc[235] * k_f[235]/K_c[235] * cs[14] * cs[32];
  q[235] =   q_f + q_b;

  q_f =   k_f[236] * cs[1] * cs[40];
  q_b = - k_f[236]/K_c[236] * cs[41];
  q[236] =   q_f + q_b;

  q_f =   S_tbc[237] * k_f[237] * cs[30] * cs[41];
  q_b = - S_tbc[237] * k_f[237]/K_c[237] * cs[10] * cs[47];
  q[237] =   q_f + q_b;

  q_f =   S_tbc[238] * k_f[238] * cs[8] * cs[47];
  q_b = - S_tbc[238] * k_f[238]/K_c[238] * cs[30] * cs[39];
  q[238] =   q_f + q_b;

  q_f =   S_tbc[239] * k_f[239] * cs[9] * cs[47];
  q_b = - S_tbc[239] * k_f[239]/K_c[239] * cs[30] * cs[40];
  q[239] =   q_f + q_b;

  q_f =   k_f[240] * cs[9] * cs[47];
  q_b = - k_f[240]/K_c[240] * cs[42];
  q[240] =   q_f + q_b;

  q_f =   S_tbc[241] * k_f[241] * cs[10] * cs[47];
  q_b = - S_tbc[241] * k_f[241]/K_c[241] * cs[31] * cs[40];
  q[241] =   q_f + q_b;

  q_f =   S_tbc[242] * k_f[242] * cs[11] * cs[47];
  q_b = - S_tbc[242] * k_f[242]/K_c[242] * cs[31] * cs[40];
  q[242] =   q_f + q_b;

  q_f =   S_tbc[243] * k_f[243] * cs[8] * cs[35];
  q_b = - S_tbc[243] * k_f[243]/K_c[243] * cs[2] * cs[39];
  q[243] =   q_f + q_b;

  q_f =   S_tbc[244] * k_f[244] * cs[8] * cs[35];
  q_b = - S_tbc[244] * k_f[244]/K_c[244] * cs[14] * cs[30];
  q[244] =   q_f + q_b;

  q_f =   S_tbc[245] * k_f[245] * cs[9] * cs[35];
  q_b = - S_tbc[245] * k_f[245]/K_c[245] * cs[2] * cs[40];
  q[245] =   q_f + q_b;

  q_f =   S_tbc[246] * k_f[246] * cs[9] * cs[35];
  q_b = - S_tbc[246] * k_f[246]/K_c[246] * cs[1] * cs[46];
  q[246] =   q_f + q_b;

  q_f =   S_tbc[247] * k_f[247] * cs[9] * cs[35];
  q_b = - S_tbc[247] * k_f[247]/K_c[247] * cs[16] * cs[30];
  q[247] =   q_f + q_b;

  q_f =   S_tbc[248] * k_f[248] * cs[10] * cs[35];
  q_b = - S_tbc[248] * k_f[248]/K_c[248] * cs[1] * cs[45];
  q[248] =   q_f + q_b;

  q_f =   S_tbc[249] * k_f[249] * cs[10] * cs[35];
  q_b = - S_tbc[249] * k_f[249]/K_c[249] * cs[4] * cs[40];
  q[249] =   q_f + q_b;

  q_f =   S_tbc[250] * k_f[250] * cs[10] * cs[35];
  q_b = - S_tbc[250] * k_f[250]/K_c[250] * cs[1] * cs[43];
  q[250] =   q_f + q_b;

  q_f =   S_tbc[251] * k_f[251] * cs[11] * cs[35];
  q_b = - S_tbc[251] * k_f[251]/K_c[251] * cs[1] * cs[45];
  q[251] =   q_f + q_b;

  q_f =   S_tbc[252] * k_f[252] * cs[11] * cs[35];
  q_b = - S_tbc[252] * k_f[252]/K_c[252] * cs[4] * cs[40];
  q[252] =   q_f + q_b;

  q_f =   S_tbc[253] * k_f[253] * cs[11] * cs[35];
  q_b = - S_tbc[253] * k_f[253]/K_c[253] * cs[1] * cs[43];
  q[253] =   q_f + q_b;

  q_f =   S_tbc[254] * k_f[254] * cs[12] * cs[35];
  q_b = - S_tbc[254] * k_f[254]/K_c[254] * cs[5] * cs[40];
  q[254] =   q_f + q_b;

  q_f =   S_tbc[255] * k_f[255] * cs[12] * cs[35];
  q_b = - S_tbc[255] * k_f[255]/K_c[255] * cs[4] * cs[41];
  q[255] =   q_f + q_b;

  q_f =   S_tbc[256] * k_f[256] * cs[2] * cs[42];
  q_b = - S_tbc[256] * k_f[256]/K_c[256] * cs[1] * cs[14] * cs[47];
  q[256] =   q_f + q_b;

  q_f =   S_tbc[257] * k_f[257] * cs[2] * cs[42];
  q_b = - S_tbc[257] * k_f[257]/K_c[257] * cs[35] * cs[40];
  q[257] =   q_f + q_b;

  q_f =   S_tbc[258] * k_f[258] * cs[3] * cs[42];
  q_b = - S_tbc[258] * k_f[258]/K_c[258] * cs[2] * cs[16] * cs[47];
  q[258] =   q_f + q_b;

  q_f =   S_tbc[259] * k_f[259] * cs[4] * cs[42];
  q_b = - S_tbc[259] * k_f[259]/K_c[259] * cs[1] * cs[16] * cs[47];
  q[259] =   q_f + q_b;

  q_f =   S_tbc[260] * k_f[260] * cs[1] * cs[42];
  q_b = - S_tbc[260] * k_f[260]/K_c[260] * cs[10] * cs[47];
  q[260] =   q_f + q_b;

  q_f =   S_tbc[261] * k_f[261] * cs[2] * cs[45];
  q_b = - S_tbc[261] * k_f[261]/K_c[261] * cs[15] * cs[31];
  q[261] =   q_f + q_b;

  q_f =   S_tbc[262] * k_f[262] * cs[2] * cs[45];
  q_b = - S_tbc[262] * k_f[262]/K_c[262] * cs[14] * cs[38];
  q[262] =   q_f + q_b;

  q_f =   S_tbc[263] * k_f[263] * cs[2] * cs[45];
  q_b = - S_tbc[263] * k_f[263]/K_c[263] * cs[4] * cs[46];
  q[263] =   q_f + q_b;

  q_f =   S_tbc[264] * k_f[264] * cs[1] * cs[45];
  q_b = - S_tbc[264] * k_f[264]/K_c[264] * cs[14] * cs[32];
  q[264] =   q_f + q_b;

  q_f =   S_tbc[265] * k_f[265] * cs[1] * cs[45];
  q_b = - S_tbc[265] * k_f[265]/K_c[265] * cs[0] * cs[46];
  q[265] =   q_f + q_b;

  q_f =   S_tbc[266] * k_f[266] * cs[4] * cs[45];
  q_b = - S_tbc[266] * k_f[266]/K_c[266] * cs[5] * cs[46];
  q[266] =   q_f + q_b;

  q_f =   S_tbc[267] * k_f[267] * cs[4] * cs[45];
  q_b = - S_tbc[267] * k_f[267]/K_c[267] * cs[15] * cs[32];
  q[267] =   q_f + q_b;

  q_f =   S_tbc[268] * k_f[268] * cs[45];
  q_b = - S_tbc[268] * k_f[268]/K_c[268] * cs[14] * cs[31];
  q[268] =   q_f + q_b;

  q_f =   S_tbc[269] * k_f[269] * cs[1] * cs[43];
  q_b = - S_tbc[269] * k_f[269]/K_c[269] * cs[1] * cs[45];
  q[269] =   q_f + q_b;

  q_f =   S_tbc[270] * k_f[270] * cs[1] * cs[43];
  q_b = - S_tbc[270] * k_f[270]/K_c[270] * cs[4] * cs[40];
  q[270] =   q_f + q_b;

  q_f =   S_tbc[271] * k_f[271] * cs[1] * cs[43];
  q_b = - S_tbc[271] * k_f[271]/K_c[271] * cs[14] * cs[32];
  q[271] =   q_f + q_b;

  q_f =   S_tbc[272] * k_f[272] * cs[1] * cs[44];
  q_b = - S_tbc[272] * k_f[272]/K_c[272] * cs[1] * cs[45];
  q[272] =   q_f + q_b;

  q_f =   S_tbc[273] * k_f[273] * cs[27] * cs[35];
  q_b = - S_tbc[273] * k_f[273]/K_c[273] * cs[14] * cs[43];
  q[273] =   q_f + q_b;

  q_f =   S_tbc[274] * k_f[274] * cs[12] * cs[30];
  q_b = - S_tbc[274] * k_f[274]/K_c[274] * cs[1] * cs[41];
  q[274] =   q_f + q_b;

  q_f =   S_tbc[275] * k_f[275] * cs[12] * cs[30];
  q_b = - S_tbc[275] * k_f[275]/K_c[275] * cs[0] * cs[40];
  q[275] =   q_f + q_b;

  q_f =   S_tbc[276] * k_f[276] * cs[1] * cs[33];
  q_b = - S_tbc[276] * k_f[276]/K_c[276] * cs[0] * cs[32];
  q[276] =   q_f + q_b;

  q_f =   S_tbc[277] * k_f[277] * cs[4] * cs[33];
  q_b = - S_tbc[277] * k_f[277]/K_c[277] * cs[5] * cs[32];
  q[277] =   q_f + q_b;

  q_f =   S_tbc[278] * k_f[278] * cs[2] * cs[33];
  q_b = - S_tbc[278] * k_f[278]/K_c[278] * cs[4] * cs[32];
  q[278] =   q_f + q_b;

  q_f =   S_tbc[279] * k_f[279] * cs[15] * cs[31];
  q_b = - S_tbc[279] * k_f[279]/K_c[279] * cs[14] * cs[38];
  q[279] =   q_f + q_b;

  q_f =   S_tbc[280] * k_f[280] * cs[36] * cs[39];
  q_b = - S_tbc[280] * k_f[280]/K_c[280] * cs[35] * cs[46];
  q[280] =   q_f + q_b;

  q_f =   S_tbc[281] * k_f[281] * cs[36] * cs[46];
  q_b = - S_tbc[281] * k_f[281]/K_c[281] * cs[15] * cs[37];
  q[281] =   q_f + q_b;

  q_f =   S_tbc[282] * k_f[282] * cs[15] * cs[30];
  q_b = - S_tbc[282] * k_f[282]/K_c[282] * cs[14] * cs[35];
  q[282] =   q_f + q_b;

  q_f =   S_tbc[283] * k_f[283] * cs[2] * cs[12];
  q_b = - S_tbc[283] * k_f[283]/K_c[283] * cs[0] * cs[1] * cs[14];
  q[283] =   q_f;

  q_f =   S_tbc[284] * k_f[284] * cs[2] * cs[24];
  q_b = - S_tbc[284] * k_f[284]/K_c[284] * cs[1] * cs[51];
  q[284] =   q_f + q_b;

  q_f =   S_tbc[285] * k_f[285] * cs[2] * cs[25];
  q_b = - S_tbc[285] * k_f[285]/K_c[285] * cs[1] * cs[52];
  q[285] =   q_f + q_b;

  q_f =   S_tbc[286] * k_f[286] * cs[4] * cs[6];
  q_b = - S_tbc[286] * k_f[286]/K_c[286] * cs[3] * cs[5];
  q[286] =   q_f + q_b;

  q_f =   S_tbc[287] * k_f[287] * cs[4] * cs[12];
  q_b = - S_tbc[287] * k_f[287]/K_c[287] * cs[0] * cs[17];
  q[287] =   q_f;

  q_f =   k_f[288] * cs[0] * cs[9];
  q_b = - k_f[288]/K_c[288] * cs[12];
  q[288] =   q_f + q_b;

  q_f =   S_tbc[289] * k_f[289] * cs[3] * cs[10];
  q_b = - S_tbc[289] * k_f[289]/K_c[289] * pow(cs[1],2.0) * cs[15];
  q[289] =   q_f;

  q_f =   S_tbc[290] * k_f[290] * cs[3] * cs[10];
  q_b = - S_tbc[290] * k_f[290]/K_c[290] * cs[2] * cs[17];
  q[290] =   q_f + q_b;

  q_f =   S_tbc[291] * k_f[291] * pow(cs[10],2.0);
  q_b = - S_tbc[291] * k_f[291]/K_c[291] * pow(cs[1],2.0) * cs[22];
  q[291] =   q_f;

  q_f =   S_tbc[292] * k_f[292] * cs[5] * cs[11];
  q_b = - S_tbc[292] * k_f[292]/K_c[292] * cs[0] * cs[17];
  q[292] =   q_f;

  q_f =   S_tbc[293] * k_f[293] * cs[3] * cs[23];
  q_b = - S_tbc[293] * k_f[293]/K_c[293] * cs[2] * cs[51];
  q[293] =   q_f + q_b;

  q_f =   S_tbc[294] * k_f[294] * cs[3] * cs[23];
  q_b = - S_tbc[294] * k_f[294]/K_c[294] * cs[6] * cs[22];
  q[294] =   q_f + q_b;

  q_f =   S_tbc[295] * k_f[295] * cs[2] * cs[52];
  q_b = - S_tbc[295] * k_f[295]/K_c[295] * cs[4] * cs[51];
  q[295] =   q_f + q_b;

  q_f =   S_tbc[296] * k_f[296] * cs[2] * cs[52];
  q_b = - S_tbc[296] * k_f[296]/K_c[296] * cs[4] * cs[12] * cs[14];
  q[296] =   q_f;

  q_f =   S_tbc[297] * k_f[297] * cs[3] * cs[52];
  q_b = - S_tbc[297] * k_f[297]/K_c[297] * cs[6] * cs[12] * cs[14];
  q[297] =   q_f;

  q_f =   S_tbc[298] * k_f[298] * cs[1] * cs[52];
  q_b = - S_tbc[298] * k_f[298]/K_c[298] * cs[0] * cs[51];
  q[298] =   q_f + q_b;

  q_f =   S_tbc[299] * k_f[299] * cs[1] * cs[52];
  q_b = - S_tbc[299] * k_f[299]/K_c[299] * cs[0] * cs[12] * cs[14];
  q[299] =   q_f;

  q_f =   S_tbc[300] * k_f[300] * cs[4] * cs[52];
  q_b = - S_tbc[300] * k_f[300]/K_c[300] * cs[5] * cs[12] * cs[14];
  q[300] =   q_f;

  q_f =   S_tbc[301] * k_f[301] * cs[6] * cs[52];
  q_b = - S_tbc[301] * k_f[301]/K_c[301] * cs[7] * cs[12] * cs[14];
  q[301] =   q_f;

  q_f =   S_tbc[302] * k_f[302] * cs[52];
  q_b = - S_tbc[302] * k_f[302]/K_c[302] * cs[13] * cs[14];
  q[302] =   q_f;

  q_f =   k_f[303] * cs[1] * cs[28];
  q_b = - k_f[303]/K_c[303] * cs[51];
  q[303] =   q_f + q_b;

  q_f =   S_tbc[304] * k_f[304] * cs[2] * cs[51];
  q_b = - S_tbc[304] * k_f[304]/K_c[304] * cs[1] * cs[10] * cs[15];
  q[304] =   q_f;

  q_f =   S_tbc[305] * k_f[305] * cs[3] * cs[51];
  q_b = - S_tbc[305] * k_f[305]/K_c[305] * cs[4] * cs[14] * cs[17];
  q[305] =   q_f;

  q_f =   S_tbc[306] * k_f[306] * cs[3] * cs[51];
  q_b = - S_tbc[306] * k_f[306]/K_c[306] * cs[4] * pow(cs[16],2.0);
  q[306] =   q_f;

  q_f =   S_tbc[307] * k_f[307] * cs[1] * cs[51];
  q_b = - S_tbc[307] * k_f[307]/K_c[307] * cs[12] * cs[16];
  q[307] =   q_f + q_b;

  q_f =   S_tbc[308] * k_f[308] * cs[1] * cs[51];
  q_b = - S_tbc[308] * k_f[308]/K_c[308] * cs[0] * cs[28];
  q[308] =   q_f + q_b;

  q_f =   S_tbc[309] * k_f[309] * cs[4] * cs[51];
  q_b = - S_tbc[309] * k_f[309]/K_c[309] * cs[5] * cs[28];
  q[309] =   q_f + q_b;

  q_f =   S_tbc[310] * k_f[310] * cs[4] * cs[51];
  q_b = - S_tbc[310] * k_f[310]/K_c[310] * cs[16] * cs[18];
  q[310] =   q_f + q_b;

  q_f =   k_f[311] * cs[12] * cs[25];
  q_b = - k_f[311]/K_c[311] * cs[50];
  q[311] =   q_f + q_b;

  q_f =   S_tbc[312] * k_f[312] * cs[2] * cs[50];
  q_b = - S_tbc[312] * k_f[312]/K_c[312] * cs[4] * cs[49];
  q[312] =   q_f + q_b;

  q_f =   S_tbc[313] * k_f[313] * cs[1] * cs[50];
  q_b = - S_tbc[313] * k_f[313]/K_c[313] * cs[0] * cs[49];
  q[313] =   q_f + q_b;

  q_f =   S_tbc[314] * k_f[314] * cs[4] * cs[50];
  q_b = - S_tbc[314] * k_f[314]/K_c[314] * cs[5] * cs[49];
  q[314] =   q_f + q_b;

  q_f =   S_tbc[315] * k_f[315] * cs[7] * cs[49];
  q_b = - S_tbc[315] * k_f[315]/K_c[315] * cs[6] * cs[50];
  q[315] =   q_f + q_b;

  q_f =   S_tbc[316] * k_f[316] * cs[12] * cs[50];
  q_b = - S_tbc[316] * k_f[316]/K_c[316] * cs[13] * cs[49];
  q[316] =   q_f + q_b;

  q_f =   k_f[317] * cs[12] * cs[24];
  q_b = - k_f[317]/K_c[317] * cs[49];
  q[317] =   q_f + q_b;

  q_f =   S_tbc[318] * k_f[318] * cs[2] * cs[49];
  q_b = - S_tbc[318] * k_f[318]/K_c[318] * cs[17] * cs[25];
  q[318] =   q_f + q_b;

  q_f =   k_f[319] * cs[1] * cs[49];
  q_b = - k_f[319]/K_c[319] * cs[50];
  q[319] =   q_f + q_b;

  q_f =   S_tbc[320] * k_f[320] * cs[1] * cs[49];
  q_b = - S_tbc[320] * k_f[320]/K_c[320] * cs[12] * cs[25];
  q[320] =   q_f + q_b;

  q_f =   S_tbc[321] * k_f[321] * cs[4] * cs[49];
  q_b = - S_tbc[321] * k_f[321]/K_c[321] * cs[18] * cs[25];
  q[321] =   q_f + q_b;

  q_f =   S_tbc[322] * k_f[322] * cs[6] * cs[49];
  q_b = - S_tbc[322] * k_f[322]/K_c[322] * cs[3] * cs[50];
  q[322] =   q_f + q_b;

  q_f =   S_tbc[323] * k_f[323] * cs[6] * cs[49];
  q_b = - S_tbc[323] * k_f[323]/K_c[323] * cs[4] * cs[17] * cs[25];
  q[323] =   q_f;

  q_f =   S_tbc[324] * k_f[324] * cs[12] * cs[49];
  q_b = - S_tbc[324] * k_f[324]/K_c[324] * pow(cs[25],2.0);
  q[324] =   q_f + q_b;
