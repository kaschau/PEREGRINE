...
void chem_GRI30(block_ b, thtrdat_ th, int face /*=0*/, int indxI /*=0*/,
                int indxJ /*=0*/, int indxK /*=0*/, int nChemSubSteps /*=1*/,
                double dt /*1.0*/) {
  ...
  Kokkos::parallel_for(
      ...
      KOKKOS_LAMBDA(const int i, const int j, const int k) {
        ...
        for (int nSub = 0; nSub < nChemSubSteps; nSub++) {
          ...
          // Reaction #20
          k_f =
              exp(log(13500.000000000002) + 2 * logT - (956.117113647655 / T));
          ...
          // Reaction #104
          k_f =
              exp(log(6300.000000000001) + 2 * logT - (754.8293002481486 / T));
          ...
          // Reaction #120
          k_f =
              exp(log(5600.000000000001) + 2 * logT - (6038.634401985189 / T));
          ...
          // Reaction #178
          k_f =
              exp(log(9000000.000000002) + 1 * logT - (3270.9269677419775 / T));
          ...
          // Reaction #228
          k_f =
              exp(log(3800000000000000.5) - 2 * logT - (402.5756267990126 / T));
