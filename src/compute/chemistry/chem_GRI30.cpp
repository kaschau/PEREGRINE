...
//-------------------------------------------------------------------------------------------|
  ...
  k_f[0] = 120000000000.00002*pow(T,-1.0)*exp(-(0.0)/T);
   dG[0] =  -2.0*gbs[2] + gbs[3];
  K_c[0] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[0]);

  k_f[1] = 500000000000.0001*pow(T,-1.0)*exp(-(0.0)/T);
   dG[1] =  - gbs[1] - gbs[2] + gbs[4];
  K_c[1] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[1]);

  k_f[2] = 38.7*pow(T,2.7)*exp(-(3150.1542797022735)/T);
   dG[2] =  - gbs[0] + gbs[1] - gbs[2] + gbs[4];
  K_c[2] = exp(-dG[2]);

  k_f[3] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[3] =  - gbs[2] + gbs[3] + gbs[4] - gbs[6];
  K_c[3] = exp(-dG[3]);

  k_f[4] = 9630.0*pow(T,2.0)*exp(-(2012.8781339950629)/T);
   dG[4] =  - gbs[2] + gbs[4] + gbs[6] - gbs[7];
  K_c[4] = exp(-dG[4]);

  k_f[5] = 57000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[5] =   gbs[1] - gbs[2] - gbs[9] + gbs[14];
  K_c[5] = exp(-dG[5]);

  k_f[6] = 80000000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[6] =   gbs[1] - gbs[2] - gbs[10] + gbs[16];
  K_c[6] = exp(-dG[6]);

  k_f[7] = 15000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[7] =   gbs[0] - gbs[2] - gbs[11] + gbs[14];
  K_c[7] = exp(-dG[7]);

  k_f[8] = 15000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[8] =   gbs[1] - gbs[2] - gbs[11] + gbs[16];
  K_c[8] = exp(-dG[8]);

  k_f[9] = 50600000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[9] =   gbs[1] - gbs[2] - gbs[12] + gbs[17];
  K_c[9] = exp(-dG[9]);

  k_f[10] = 1020000.0000000001*pow(T,1.5)*exp(-(4327.687988089386)/T);
   dG[10] =  - gbs[2] + gbs[4] + gbs[12] - gbs[13];
  K_c[10] = exp(-dG[10]);

  k_f[11] = 18000000.000000004*pow(T,0.0)*exp(-(1200.1785873945562)/T);
   dG[11] =  - gbs[2] - gbs[14] + gbs[15];
  K_c[11] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[11]);

  k_f[12] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[12] =  - gbs[2] + gbs[4] + gbs[14] - gbs[16];
  K_c[12] = exp(-dG[12]);

  k_f[13] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[13] =   gbs[1] - gbs[2] + gbs[15] - gbs[16];
  K_c[13] = exp(-dG[13]);

  k_f[14] = 39000000000.00001*pow(T,0.0)*exp(-(1781.3971485856307)/T);
   dG[14] =  - gbs[2] + gbs[4] + gbs[16] - gbs[17];
  K_c[14] = exp(-dG[14]);

  k_f[15] = 10000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[15] =  - gbs[2] + gbs[4] + gbs[17] - gbs[18];
  K_c[15] = exp(-dG[15]);

  k_f[16] = 10000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[16] =  - gbs[2] + gbs[4] + gbs[17] - gbs[19];
  K_c[16] = exp(-dG[16]);

  k_f[17] = 388.00000000000006*pow(T,2.5)*exp(-(1559.9805538461737)/T);
   dG[17] =  - gbs[2] + gbs[4] + gbs[18] - gbs[20];
  K_c[17] = exp(-dG[17]);

  k_f[18] = 130.00000000000003*pow(T,2.5)*exp(-(2516.097667493829)/T);
   dG[18] =  - gbs[2] + gbs[4] + gbs[19] - gbs[20];
  K_c[18] = exp(-dG[18]);

  k_f[19] = 50000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[19] =  - gbs[2] + gbs[9] + gbs[14] - gbs[21];
  K_c[19] = exp(-dG[19]);

  k_f[20] = 13500.000000000002*pow(T,2.0)*exp(-(956.117113647655)/T);
   dG[20] =   gbs[1] - gbs[2] - gbs[22] + gbs[27];
  K_c[20] = exp(-dG[20]);

  k_f[21] = 4.600000000000001e+16*pow(T,-1.41)*exp(-(14568.205494789268)/T);
   dG[21] =  - gbs[2] + gbs[4] + gbs[21] - gbs[22];
  K_c[21] = exp(-dG[21]);

  k_f[22] = 6940.000000000001*pow(T,2.0)*exp(-(956.117113647655)/T);
   dG[22] =  - gbs[2] + gbs[10] + gbs[14] - gbs[22];
  K_c[22] = exp(-dG[22]);

  k_f[23] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[23] =   gbs[1] - gbs[2] - gbs[23] + gbs[28];
  K_c[23] = exp(-dG[23]);

  k_f[24] = 12500.000000000002*pow(T,1.83)*exp(-(110.70829736972846)/T);
   dG[24] =  - gbs[2] + gbs[12] + gbs[16] - gbs[24];
  K_c[24] = exp(-dG[24]);

  k_f[25] = 22400000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[25] =  - gbs[2] + gbs[12] + gbs[17] - gbs[25];
  K_c[25] = exp(-dG[25]);

  k_f[26] = 89800.00000000001*pow(T,1.92)*exp(-(2863.319145607977)/T);
   dG[26] =  - gbs[2] + gbs[4] + gbs[25] - gbs[26];
  K_c[26] = exp(-dG[26]);

  k_f[27] = 100000000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[27] =   gbs[1] - gbs[2] +2.0*gbs[14] - gbs[27];
  K_c[27] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[27]);

  k_f[28] = 10000000000.000002*pow(T,0.0)*exp(-(4025.7562679901257)/T);
   dG[28] =  - gbs[2] + gbs[4] + gbs[27] - gbs[28];
  K_c[28] = exp(-dG[28]);

  k_f[29] = 1750000000.0000002*pow(T,0.0)*exp(-(679.3463702233338)/T);
   dG[29] =  - gbs[2] + gbs[10] + gbs[15] - gbs[28];
  K_c[29] = exp(-dG[29]);

  k_f[30] = 2500000000.0000005*pow(T,0.0)*exp(-(24053.893701241002)/T);
   dG[30] =   gbs[2] - gbs[3] - gbs[14] + gbs[15];
  K_c[30] = exp(-dG[30]);

  k_f[31] = 100000000000.00002*pow(T,0.0)*exp(-(20128.78133995063)/T);
   dG[31] =  - gbs[3] + gbs[6] + gbs[16] - gbs[17];
  K_c[31] = exp(-dG[31]);

  k_f[32] = 2800000000000.0005*pow(T,-0.86)*exp(-(0.0)/T);
   dG[32] =  - gbs[1] - gbs[3] + gbs[6];
  K_c[32] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[32]);

  k_f[33] = 20800000000000.004*pow(T,-1.24)*exp(-(0.0)/T);
   dG[33] =  - gbs[1] - gbs[3] + gbs[6];
  K_c[33] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[33]);

  k_f[34] = 11260000000000.002*pow(T,-0.76)*exp(-(0.0)/T);
   dG[34] =  - gbs[1] - gbs[3] + gbs[6];
  K_c[34] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[34]);

  k_f[35] = 26000000000000.004*pow(T,-1.24)*exp(-(0.0)/T);
   dG[35] =  - gbs[1] - gbs[3] + gbs[6];
  K_c[35] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[35]);

  k_f[36] = 700000000000.0001*pow(T,-0.8)*exp(-(0.0)/T);
   dG[36] =  - gbs[1] - gbs[3] + gbs[6];
  K_c[36] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[36]);

  k_f[37] = 26500000000000.004*pow(T,-0.6707)*exp(-(8575.364070352467)/T);
   dG[37] =  - gbs[1] + gbs[2] - gbs[3] + gbs[4];
  K_c[37] = exp(-dG[37]);

  k_f[38] = 1000000000000.0002*pow(T,-1.0)*exp(-(0.0)/T);
   dG[38] =   gbs[0] -2.0*gbs[1];
  K_c[38] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[38]);

  k_f[39] = 90000000000.00002*pow(T,-0.6)*exp(-(0.0)/T);
   dG[39] =   gbs[0] -2.0*gbs[1];
  K_c[39] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[39]);

  k_f[40] = 60000000000000.01*pow(T,-1.25)*exp(-(0.0)/T);
   dG[40] =   gbs[0] -2.0*gbs[1];
  K_c[40] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[40]);

  k_f[41] = 550000000000000.1*pow(T,-2.0)*exp(-(0.0)/T);
   dG[41] =   gbs[0] -2.0*gbs[1];
  K_c[41] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[41]);

  k_f[42] = 2.2000000000000004e+16*pow(T,-2.0)*exp(-(0.0)/T);
   dG[42] =  - gbs[1] - gbs[4] + gbs[5];
  K_c[42] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[42]);

  k_f[43] = 3970000000.0000005*pow(T,0.0)*exp(-(337.66030697767184)/T);
   dG[43] =  - gbs[1] + gbs[2] + gbs[5] - gbs[6];
  K_c[43] = exp(-dG[43]);

  k_f[44] = 44800000000.00001*pow(T,0.0)*exp(-(537.4384617766818)/T);
   dG[44] =   gbs[0] - gbs[1] + gbs[3] - gbs[6];
  K_c[44] = exp(-dG[44]);

  k_f[45] = 84000000000.00002*pow(T,0.0)*exp(-(319.54440377171625)/T);
   dG[45] =  - gbs[1] +2.0*gbs[4] - gbs[6];
  K_c[45] = exp(-dG[45]);

  k_f[46] = 12100.000000000002*pow(T,2.0)*exp(-(2616.741574193582)/T);
   dG[46] =   gbs[0] - gbs[1] + gbs[6] - gbs[7];
  K_c[46] = exp(-dG[46]);

  k_f[47] = 10000000000.000002*pow(T,0.0)*exp(-(1811.5903205955567)/T);
   dG[47] =  - gbs[1] + gbs[4] + gbs[5] - gbs[7];
  K_c[47] = exp(-dG[47]);

  k_f[48] = 165000000000.00003*pow(T,0.0)*exp(-(0.0)/T);
   dG[48] =   gbs[0] - gbs[1] + gbs[8] - gbs[9];
  K_c[48] = exp(-dG[48]);

  k_f[49] = 600000000000.0001*pow(T,0.0)*exp(-(0.0)/T);
   dG[49] =  - gbs[1] - gbs[10] + gbs[12];
  K_c[49] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[49]);

  k_f[50] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[50] =   gbs[0] - gbs[1] + gbs[9] - gbs[11];
  K_c[50] = exp(-dG[50]);

  k_f[51] = 13900000000000.002*pow(T,-0.534)*exp(-(269.72566995533845)/T);
   dG[51] =  - gbs[1] - gbs[12] + gbs[13];
  K_c[51] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[51]);

  k_f[52] = 660000.0000000001*pow(T,1.62)*exp(-(5454.899743126621)/T);
   dG[52] =   gbs[0] - gbs[1] + gbs[12] - gbs[13];
  K_c[52] = exp(-dG[52]);

  k_f[53] = 1090000000.0000002*pow(T,0.48)*exp(-(-130.8370787096791)/T);
   dG[53] =  - gbs[1] - gbs[16] + gbs[17];
  K_c[53] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[53]);

  k_f[54] = 73400000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[54] =   gbs[0] - gbs[1] + gbs[14] - gbs[16];
  K_c[54] = exp(-dG[54]);

  k_f[55] = 540000000.0000001*pow(T,0.454)*exp(-(1811.5903205955567)/T);
   dG[55] =  - gbs[1] - gbs[17] + gbs[18];
  K_c[55] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[55]);

  k_f[56] = 540000000.0000001*pow(T,0.454)*exp(-(1308.370787096791)/T);
   dG[56] =  - gbs[1] - gbs[17] + gbs[19];
  K_c[56] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[56]);

  k_f[57] = 57400.000000000015*pow(T,1.9)*exp(-(1379.8279608536157)/T);
   dG[57] =   gbs[0] - gbs[1] + gbs[16] - gbs[17];
  K_c[57] = exp(-dG[57]);

  k_f[58] = 1055000000.0000002*pow(T,0.5)*exp(-(43.27687988089385)/T);
   dG[58] =  - gbs[1] - gbs[18] + gbs[20];
  K_c[58] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[58]);

  k_f[59] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[59] =   gbs[0] - gbs[1] + gbs[17] - gbs[18];
  K_c[59] = exp(-dG[59]);

  k_f[60] = 165000000.00000003*pow(T,0.65)*exp(-(-142.91434751364946)/T);
   dG[60] =  - gbs[1] + gbs[4] + gbs[12] - gbs[18];
  K_c[60] = exp(-dG[60]);

  k_f[61] = 32800000000.000004*pow(T,-0.09)*exp(-(306.9639154342471)/T);
   dG[61] =  - gbs[1] + gbs[5] + gbs[11] - gbs[18];
  K_c[61] = exp(-dG[61]);

  k_f[62] = 2430000000.0000005*pow(T,0.515)*exp(-(25.160976674938286)/T);
   dG[62] =  - gbs[1] - gbs[19] + gbs[20];
  K_c[62] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[62]);

  k_f[63] = 41500.00000000001*pow(T,1.63)*exp(-(968.1943824516253)/T);
   dG[63] =   gbs[18] - gbs[19];
  K_c[63] = exp(-dG[63]);

  k_f[64] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[64] =   gbs[0] - gbs[1] + gbs[17] - gbs[19];
  K_c[64] = exp(-dG[64]);

  k_f[65] = 1500000000.0000002*pow(T,0.5)*exp(-(-55.35414868486423)/T);
   dG[65] =  - gbs[1] + gbs[4] + gbs[12] - gbs[19];
  K_c[65] = exp(-dG[65]);

  k_f[66] = 262000000000.00003*pow(T,-0.23)*exp(-(538.4449008436793)/T);
   dG[66] =  - gbs[1] + gbs[5] + gbs[11] - gbs[19];
  K_c[66] = exp(-dG[66]);

  k_f[67] = 17000.000000000004*pow(T,2.1)*exp(-(2450.679128138989)/T);
   dG[67] =   gbs[0] - gbs[1] + gbs[18] - gbs[20];
  K_c[67] = exp(-dG[67]);

  k_f[68] = 4200.000000000001*pow(T,2.1)*exp(-(2450.679128138989)/T);
   dG[68] =   gbs[0] - gbs[1] + gbs[19] - gbs[20];
  K_c[68] = exp(-dG[68]);

  k_f[69] = 100000000000000.02*pow(T,-1.0)*exp(-(0.0)/T);
   dG[69] =  - gbs[1] - gbs[21] + gbs[22];
  K_c[69] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[69]);

  k_f[70] = 5600000000.000001*pow(T,0.0)*exp(-(1207.7268803970378)/T);
   dG[70] =  - gbs[1] - gbs[22] + gbs[23];
  K_c[70] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[70]);

  k_f[71] = 6080000000.000001*pow(T,0.27)*exp(-(140.9014693796544)/T);
   dG[71] =  - gbs[1] - gbs[23] + gbs[24];
  K_c[71] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[71]);

  k_f[72] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[72] =   gbs[0] - gbs[1] + gbs[22] - gbs[23];
  K_c[72] = exp(-dG[72]);

  k_f[73] = 540000000.0000001*pow(T,0.454)*exp(-(915.8595509677536)/T);
   dG[73] =  - gbs[1] - gbs[24] + gbs[25];
  K_c[73] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[73]);

  k_f[74] = 1325.0000000000002*pow(T,2.53)*exp(-(6159.407090024893)/T);
   dG[74] =   gbs[0] - gbs[1] + gbs[23] - gbs[24];
  K_c[74] = exp(-dG[74]);

  k_f[75] = 521000000000000.06*pow(T,-0.99)*exp(-(795.0868629280499)/T);
   dG[75] =  - gbs[1] - gbs[25] + gbs[26];
  K_c[75] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[75]);

  k_f[76] = 2000000000.0000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[76] =   gbs[0] - gbs[1] + gbs[24] - gbs[25];
  K_c[76] = exp(-dG[76]);

  k_f[77] = 115000.00000000001*pow(T,1.9)*exp(-(3789.243087245706)/T);
   dG[77] =   gbs[0] - gbs[1] + gbs[25] - gbs[26];
  K_c[77] = exp(-dG[77]);

  k_f[78] = 100000000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[78] =  - gbs[1] + gbs[11] + gbs[14] - gbs[27];
  K_c[78] = exp(-dG[78]);

  k_f[79] = 50000000000.00001*pow(T,0.0)*exp(-(4025.7562679901257)/T);
   dG[79] =   gbs[0] - gbs[1] + gbs[27] - gbs[28];
  K_c[79] = exp(-dG[79]);

  k_f[80] = 11300000000.000002*pow(T,0.0)*exp(-(1725.036560833769)/T);
   dG[80] =  - gbs[1] + gbs[12] + gbs[14] - gbs[28];
  K_c[80] = exp(-dG[80]);

  k_f[81] = 10000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[81] =   gbs[28] - gbs[29];
  K_c[81] = exp(-dG[81]);

  k_f[82] = 43000.00000000001*pow(T,1.5)*exp(-(40056.27486650175)/T);
   dG[82] =  - gbs[0] - gbs[14] + gbs[17];
  K_c[82] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[82]);

  k_f[83] = 216000.00000000003*pow(T,1.51)*exp(-(1726.0429999007665)/T);
   dG[83] =  - gbs[0] + gbs[1] - gbs[4] + gbs[5];
  K_c[83] = exp(-dG[83]);

  k_f[84] = 74000000000.00002*pow(T,-0.37)*exp(-(0.0)/T);
   dG[84] =  -2.0*gbs[4] + gbs[7];
  K_c[84] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[84]);

  k_f[85] = 35.7*pow(T,2.4)*exp(-(-1061.7932156823956)/T);
   dG[85] =   gbs[2] -2.0*gbs[4] + gbs[5];
  K_c[85] = exp(-dG[85]);

  k_f[86] = 14500000000.000002*pow(T,0.0)*exp(-(-251.60976674938286)/T);
   dG[86] =   gbs[3] - gbs[4] + gbs[5] - gbs[6];
  K_c[86] = exp(-dG[86]);

  k_f[87] = 2000000000.0000002*pow(T,0.0)*exp(-(214.87474080397297)/T);
   dG[87] =  - gbs[4] + gbs[5] + gbs[6] - gbs[7];
  K_c[87] = exp(-dG[87]);

  k_f[88] = 1700000000000000.2*pow(T,0.0)*exp(-(14799.686480198701)/T);
   dG[88] =  - gbs[4] + gbs[5] + gbs[6] - gbs[7];
  K_c[88] = exp(-dG[88]);

  k_f[89] = 50000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[89] =   gbs[1] - gbs[4] - gbs[8] + gbs[14];
  K_c[89] = exp(-dG[89]);

  k_f[90] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[90] =   gbs[1] - gbs[4] - gbs[9] + gbs[16];
  K_c[90] = exp(-dG[90]);

  k_f[91] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[91] =   gbs[1] - gbs[4] - gbs[10] + gbs[17];
  K_c[91] = exp(-dG[91]);

  k_f[92] = 11300.000000000002*pow(T,2.0)*exp(-(1509.6586004962971)/T);
   dG[92] =  - gbs[4] + gbs[5] + gbs[9] - gbs[10];
  K_c[92] = exp(-dG[92]);

  k_f[93] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[93] =   gbs[1] - gbs[4] - gbs[11] + gbs[17];
  K_c[93] = exp(-dG[93]);

  k_f[94] = 2790000000000000.5*pow(T,-1.43)*exp(-(669.2819795533584)/T);
   dG[94] =  - gbs[4] - gbs[12] + gbs[20];
  K_c[94] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[94]);

  k_f[95] = 56000.00000000001*pow(T,1.6)*exp(-(2727.4498715633104)/T);
   dG[95] =  - gbs[4] + gbs[5] + gbs[10] - gbs[12];
  K_c[95] = exp(-dG[95]);

  k_f[96] = 644000000000000.1*pow(T,-1.34)*exp(-(713.0620789677511)/T);
   dG[96] =  - gbs[4] + gbs[5] + gbs[11] - gbs[12];
  K_c[96] = exp(-dG[96]);

  k_f[97] = 100000.00000000001*pow(T,1.6)*exp(-(1570.0449445161491)/T);
   dG[97] =  - gbs[4] + gbs[5] + gbs[12] - gbs[13];
  K_c[97] = exp(-dG[97]);

  k_f[98] = 47600.00000000001*pow(T,1.228)*exp(-(35.2253673449136)/T);
   dG[98] =   gbs[1] - gbs[4] - gbs[14] + gbs[15];
  K_c[98] = exp(-dG[98]);

  k_f[99] = 50000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[99] =  - gbs[4] + gbs[5] + gbs[14] - gbs[16];
  K_c[99] = exp(-dG[99]);

  k_f[100] = 3430000.0000000005*pow(T,1.18)*exp(-(-224.9391314739483)/T);
   dG[100] =  - gbs[4] + gbs[5] + gbs[16] - gbs[17];
  K_c[100] = exp(-dG[100]);

  k_f[101] = 5000000000.000001*pow(T,0.0)*exp(-(0.0)/T);
   dG[101] =  - gbs[4] + gbs[5] + gbs[17] - gbs[18];
  K_c[101] = exp(-dG[101]);

  k_f[102] = 5000000000.000001*pow(T,0.0)*exp(-(0.0)/T);
   dG[102] =  - gbs[4] + gbs[5] + gbs[17] - gbs[19];
  K_c[102] = exp(-dG[102]);

  k_f[103] = 1440.0000000000002*pow(T,2.0)*exp(-(-422.70440813896323)/T);
   dG[103] =  - gbs[4] + gbs[5] + gbs[18] - gbs[20];
  K_c[103] = exp(-dG[103]);

  k_f[104] = 6300.000000000001*pow(T,2.0)*exp(-(754.8293002481486)/T);
   dG[104] =  - gbs[4] + gbs[5] + gbs[19] - gbs[20];
  K_c[104] = exp(-dG[104]);

  k_f[105] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[105] =   gbs[1] - gbs[4] - gbs[21] + gbs[27];
  K_c[105] = exp(-dG[105]);

  k_f[106] = 2.1800000000000005e-07*pow(T,4.5)*exp(-(-503.2195334987657)/T);
   dG[106] =   gbs[1] - gbs[4] - gbs[22] + gbs[28];
  K_c[106] = exp(-dG[106]);

  k_f[107] = 504.0000000000001*pow(T,2.3)*exp(-(6793.463702233337)/T);
   dG[107] =   gbs[1] - gbs[4] - gbs[22] + gbs[29];
  K_c[107] = exp(-dG[107]);

  k_f[108] = 33700.0*pow(T,2.0)*exp(-(7045.07346898272)/T);
   dG[108] =  - gbs[4] + gbs[5] + gbs[21] - gbs[22];
  K_c[108] = exp(-dG[108]);

  k_f[109] = 4.830000000000001e-07*pow(T,4.0)*exp(-(-1006.4390669975314)/T);
   dG[109] =  - gbs[4] + gbs[12] + gbs[14] - gbs[22];
  K_c[109] = exp(-dG[109]);

  k_f[110] = 5000000000.000001*pow(T,0.0)*exp(-(0.0)/T);
   dG[110] =  - gbs[4] + gbs[5] + gbs[22] - gbs[23];
  K_c[110] = exp(-dG[110]);

  k_f[111] = 3600.0000000000005*pow(T,2.0)*exp(-(1258.0488337469144)/T);
   dG[111] =  - gbs[4] + gbs[5] + gbs[23] - gbs[24];
  K_c[111] = exp(-dG[111]);

  k_f[112] = 3540.0000000000005*pow(T,2.12)*exp(-(437.8009941439262)/T);
   dG[112] =  - gbs[4] + gbs[5] + gbs[25] - gbs[26];
  K_c[112] = exp(-dG[112]);

  k_f[113] = 7500000000.000001*pow(T,0.0)*exp(-(1006.4390669975314)/T);
   dG[113] =  - gbs[4] + gbs[5] + gbs[27] - gbs[28];
  K_c[113] = exp(-dG[113]);

  k_f[114] = 130000000.00000001*pow(T,0.0)*exp(-(-820.2478396029882)/T);
   dG[114] =   gbs[3] -2.0*gbs[6] + gbs[7];
  K_c[114] = exp(-dG[114]);

  k_f[115] = 420000000000.00006*pow(T,0.0)*exp(-(6038.634401985189)/T);
   dG[115] =   gbs[3] -2.0*gbs[6] + gbs[7];
  K_c[115] = exp(-dG[115]);

  k_f[116] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[116] =   gbs[4] - gbs[6] - gbs[10] + gbs[17];
  K_c[116] = exp(-dG[116]);

  k_f[117] = 1000000000.0000001*pow(T,0.0)*exp(-(0.0)/T);
   dG[117] =   gbs[3] - gbs[6] - gbs[12] + gbs[13];
  K_c[117] = exp(-dG[117]);

  k_f[118] = 37800000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[118] =   gbs[4] - gbs[6] - gbs[12] + gbs[19];
  K_c[118] = exp(-dG[118]);

  k_f[119] = 150000000000.00003*pow(T,0.0)*exp(-(11875.980990570872)/T);
   dG[119] =   gbs[4] - gbs[6] - gbs[14] + gbs[15];
  K_c[119] = exp(-dG[119]);

  k_f[120] = 5600.000000000001*pow(T,2.0)*exp(-(6038.634401985189)/T);
   dG[120] =  - gbs[6] + gbs[7] + gbs[16] - gbs[17];
  K_c[120] = exp(-dG[120]);

  k_f[121] = 58000000000.00001*pow(T,0.0)*exp(-(289.85445129528904)/T);
   dG[121] =   gbs[2] - gbs[3] - gbs[8] + gbs[14];
  K_c[121] = exp(-dG[121]);

  k_f[122] = 50000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[122] =   gbs[1] - gbs[8] - gbs[10] + gbs[21];
  K_c[122] = exp(-dG[122]);

  k_f[123] = 50000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[123] =   gbs[1] - gbs[8] - gbs[12] + gbs[22];
  K_c[123] = exp(-dG[123]);

  k_f[124] = 67100000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[124] =   gbs[2] - gbs[3] - gbs[9] + gbs[16];
  K_c[124] = exp(-dG[124]);

  k_f[125] = 108000000000.00002*pow(T,0.0)*exp(-(1565.0127491811616)/T);
   dG[125] =  - gbs[0] + gbs[1] - gbs[9] + gbs[10];
  K_c[125] = exp(-dG[125]);

  k_f[126] = 5710000000.000001*pow(T,0.0)*exp(-(-379.93074779156814)/T);
   dG[126] =   gbs[1] - gbs[5] - gbs[9] + gbs[17];
  K_c[126] = exp(-dG[126]);

  k_f[127] = 40000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[127] =   gbs[1] - gbs[9] - gbs[10] + gbs[22];
  K_c[127] = exp(-dG[127]);

  k_f[128] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[128] =   gbs[1] - gbs[9] - gbs[12] + gbs[23];
  K_c[128] = exp(-dG[128]);

  k_f[129] = 60000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[129] =   gbs[1] - gbs[9] - gbs[13] + gbs[24];
  K_c[129] = exp(-dG[129]);

  k_f[130] = 50000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[130] =  - gbs[9] - gbs[14] + gbs[27];
  K_c[130] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[130]);

  k_f[131] = 190000000000.00003*pow(T,0.0)*exp(-(7946.842873012509)/T);
   dG[131] =  - gbs[9] + gbs[14] - gbs[15] + gbs[16];
  K_c[131] = exp(-dG[131]);

  k_f[132] = 94600000000.00002*pow(T,0.0)*exp(-(-259.15805975186436)/T);
   dG[132] =   gbs[1] - gbs[9] - gbs[17] + gbs[28];
  K_c[132] = exp(-dG[132]);

  k_f[133] = 50000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[133] =  - gbs[9] + gbs[14] + gbs[22] - gbs[27];
  K_c[133] = exp(-dG[133]);

  k_f[134] = 5000000000.000001*pow(T,0.0)*exp(-(754.8293002481486)/T);
   dG[134] =   gbs[1] - gbs[3] + gbs[4] - gbs[10] + gbs[14];
  K_c[134] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[134]);

  k_f[135] = 500.0000000000001*pow(T,2.0)*exp(-(3638.277227196076)/T);
   dG[135] =  - gbs[0] + gbs[1] - gbs[10] + gbs[12];
  K_c[135] = exp(-dG[135]);

  k_f[136] = 1600000000000.0002*pow(T,0.0)*exp(-(6010.454108109258)/T);
   dG[136] =   gbs[0] -2.0*gbs[10] + gbs[22];
  K_c[136] = exp(-dG[136]);

  k_f[137] = 40000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[137] =   gbs[1] - gbs[10] - gbs[12] + gbs[24];
  K_c[137] = exp(-dG[137]);

  k_f[138] = 2460.0000000000005*pow(T,2.0)*exp(-(4161.6255420347925)/T);
   dG[138] =  - gbs[10] +2.0*gbs[12] - gbs[13];
  K_c[138] = exp(-dG[138]);

  k_f[139] = 810000000.0000001*pow(T,0.5)*exp(-(2269.5200960794336)/T);
   dG[139] =  - gbs[10] - gbs[14] + gbs[28];
  K_c[139] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[139]);

  k_f[140] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[140] =  - gbs[10] + gbs[14] + gbs[23] - gbs[27];
  K_c[140] = exp(-dG[140]);

  k_f[141] = 15000000000.000002*pow(T,0.0)*exp(-(301.93172009925945)/T);
   dG[141] =   gbs[10] - gbs[11];
  K_c[141] = exp(-dG[141]);

  k_f[142] = 9000000000.000002*pow(T,0.0)*exp(-(301.93172009925945)/T);
   dG[142] =   gbs[10] - gbs[11];
  K_c[142] = exp(-dG[142]);

  k_f[143] = 28000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[143] =   gbs[1] - gbs[3] + gbs[4] - gbs[11] + gbs[14];
  K_c[143] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[143]);

  k_f[144] = 12000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[144] =  - gbs[3] + gbs[5] - gbs[11] + gbs[14];
  K_c[144] = exp(-dG[144]);

  k_f[145] = 70000000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[145] =  - gbs[0] + gbs[1] - gbs[11] + gbs[12];
  K_c[145] = exp(-dG[145]);

  k_f[146] = 482000000000000.06*pow(T,-1.16)*exp(-(576.1863658560868)/T);
   dG[146] =  - gbs[5] - gbs[11] + gbs[20];
  K_c[146] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[146]);

  k_f[147] = 30000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[147] =   gbs[10] - gbs[11];
  K_c[147] = exp(-dG[147]);

  k_f[148] = 12000000000.000002*pow(T,0.0)*exp(-(-286.83513409429645)/T);
   dG[148] =   gbs[1] - gbs[11] - gbs[12] + gbs[24];
  K_c[148] = exp(-dG[148]);

  k_f[149] = 16000000000.000002*pow(T,0.0)*exp(-(-286.83513409429645)/T);
   dG[149] =  - gbs[11] +2.0*gbs[12] - gbs[13];
  K_c[149] = exp(-dG[149]);

  k_f[150] = 9000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[150] =   gbs[10] - gbs[11];
  K_c[150] = exp(-dG[150]);

  k_f[151] = 7000000000.000001*pow(T,0.0)*exp(-(0.0)/T);
   dG[151] =   gbs[10] - gbs[11];
  K_c[151] = exp(-dG[151]);

  k_f[152] = 14000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[152] =  - gbs[11] + gbs[14] - gbs[15] + gbs[17];
  K_c[152] = exp(-dG[152]);

  k_f[153] = 40000000000.00001*pow(T,0.0)*exp(-(-276.77074342432115)/T);
   dG[153] =  - gbs[11] + gbs[12] + gbs[25] - gbs[26];
  K_c[153] = exp(-dG[153]);

  k_f[154] = 35600000000.00001*pow(T,0.0)*exp(-(15338.13138104238)/T);
   dG[154] =   gbs[2] - gbs[3] - gbs[12] + gbs[19];
  K_c[154] = exp(-dG[154]);

  k_f[155] = 2310000000.0000005*pow(T,0.0)*exp(-(10222.904823027426)/T);
   dG[155] =  - gbs[3] + gbs[4] - gbs[12] + gbs[17];
  K_c[155] = exp(-dG[155]);

  k_f[156] = 24.500000000000004*pow(T,2.47)*exp(-(2606.6771835236063)/T);
   dG[156] =   gbs[6] - gbs[7] - gbs[12] + gbs[13];
  K_c[156] = exp(-dG[156]);

  k_f[157] = 67700000000000.01*pow(T,-1.18)*exp(-(329.1055749081928)/T);
   dG[157] =  -2.0*gbs[12] + gbs[26];
  K_c[157] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[157]);

  k_f[158] = 6840000000.000001*pow(T,0.1)*exp(-(5334.127055086917)/T);
   dG[158] =   gbs[1] -2.0*gbs[12] + gbs[25];
  K_c[158] = exp(-dG[158]);

  k_f[159] = 26480000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[159] =  - gbs[12] + gbs[13] + gbs[14] - gbs[16];
  K_c[159] = exp(-dG[159]);

  k_f[160] = 3.3200000000000003*pow(T,2.81)*exp(-(2948.866466302767)/T);
   dG[160] =  - gbs[12] + gbs[13] + gbs[16] - gbs[17];
  K_c[160] = exp(-dG[160]);

  k_f[161] = 30000.000000000004*pow(T,1.5)*exp(-(5002.002162977731)/T);
   dG[161] =  - gbs[12] + gbs[13] + gbs[18] - gbs[20];
  K_c[161] = exp(-dG[161]);

  k_f[162] = 10000.000000000002*pow(T,1.5)*exp(-(5002.002162977731)/T);
   dG[162] =  - gbs[12] + gbs[13] + gbs[19] - gbs[20];
  K_c[162] = exp(-dG[162]);

  k_f[163] = 227.00000000000003*pow(T,2.0)*exp(-(4629.619708188645)/T);
   dG[163] =  - gbs[12] + gbs[13] + gbs[23] - gbs[24];
  K_c[163] = exp(-dG[163]);

  k_f[164] = 6140.000000000002*pow(T,1.74)*exp(-(5258.644125062102)/T);
   dG[164] =  - gbs[12] + gbs[13] + gbs[25] - gbs[26];
  K_c[164] = exp(-dG[164]);

  k_f[165] = 1500000000000000.2*pow(T,-1.0)*exp(-(8554.732069479018)/T);
   dG[165] =   gbs[1] + gbs[14] - gbs[16];
  K_c[165] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[165]);

  k_f[166] = 187000000000000.03*pow(T,-1.0)*exp(-(8554.732069479018)/T);
   dG[166] =   gbs[1] + gbs[14] - gbs[16];
  K_c[166] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[166]);

  k_f[167] = 13450000000.000002*pow(T,0.0)*exp(-(201.2878133995063)/T);
   dG[167] =  - gbs[3] + gbs[6] + gbs[14] - gbs[16];
  K_c[167] = exp(-dG[167]);

  k_f[168] = 18000000000.000004*pow(T,0.0)*exp(-(452.8975801488892)/T);
   dG[168] =  - gbs[3] + gbs[6] + gbs[17] - gbs[18];
  K_c[168] = exp(-dG[168]);

  k_f[169] = 4.2800000000000005e-16*pow(T,7.6)*exp(-(-1776.364953250643)/T);
   dG[169] =  - gbs[3] + gbs[6] + gbs[17] - gbs[19];
  K_c[169] = exp(-dG[169]);

  k_f[170] = 10000000000.000002*pow(T,0.0)*exp(-(-379.93074779156814)/T);
   dG[170] =  - gbs[3] + gbs[14] + gbs[16] - gbs[21];
  K_c[170] = exp(-dG[170]);

  k_f[171] = 56800000.00000001*pow(T,0.9)*exp(-(1002.9165302630402)/T);
   dG[171] =  - gbs[0] + gbs[1] - gbs[21] + gbs[22];
  K_c[171] = exp(-dG[171]);

  k_f[172] = 45800000000000.01*pow(T,-1.39)*exp(-(510.7678265012472)/T);
   dG[172] =  - gbs[3] + gbs[16] + gbs[17] - gbs[23];
  K_c[172] = exp(-dG[172]);

  k_f[173] = 8000000000000.0*pow(T,0.44)*exp(-(43664.358921687905)/T);
   dG[173] =   gbs[0] + gbs[22] - gbs[24];
  K_c[173] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[173]);

  k_f[174] = 840000000.0000001*pow(T,0.0)*exp(-(1949.9756923077173)/T);
   dG[174] =  - gbs[3] + gbs[6] + gbs[24] - gbs[25];
  K_c[174] = exp(-dG[174]);

  k_f[175] = 3200000000.0000005*pow(T,0.0)*exp(-(429.74948160794594)/T);
   dG[175] =  - gbs[3] + gbs[4] +2.0*gbs[14] - gbs[27];
  K_c[175] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[175]);

  k_f[176] = 10000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[176] =  2.0*gbs[14] + gbs[22] -2.0*gbs[27];
  K_c[176] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[176]);

  k_f[177] = 27000000000.000004*pow(T,0.0)*exp(-(178.64293439206185)/T);
   dG[177] =   gbs[2] - gbs[30] - gbs[35] + gbs[47];
  K_c[177] = exp(-dG[177]);

  k_f[178] = 9000000.000000002*pow(T,1.0)*exp(-(3270.9269677419775)/T);
   dG[178] =   gbs[2] - gbs[3] - gbs[30] + gbs[35];
  K_c[178] = exp(-dG[178]);

  k_f[179] = 33600000000.000008*pow(T,0.0)*exp(-(193.73952039702482)/T);
   dG[179] =   gbs[1] - gbs[4] - gbs[30] + gbs[35];
  K_c[179] = exp(-dG[179]);

  k_f[180] = 1400000000.0000002*pow(T,0.0)*exp(-(5439.803157121658)/T);
   dG[180] =  - gbs[2] + gbs[3] - gbs[37] + gbs[47];
  K_c[180] = exp(-dG[180]);

  k_f[181] = 29000000000.000004*pow(T,0.0)*exp(-(11649.532200496427)/T);
   dG[181] =  - gbs[2] +2.0*gbs[35] - gbs[37];
  K_c[181] = exp(-dG[181]);

  k_f[182] = 387000000000.00006*pow(T,0.0)*exp(-(9500.784792456698)/T);
   dG[182] =  - gbs[1] + gbs[4] - gbs[37] + gbs[47];
  K_c[182] = exp(-dG[182]);

  k_f[183] = 2000000000.0000002*pow(T,0.0)*exp(-(10597.803375484007)/T);
   dG[183] =  - gbs[4] + gbs[6] - gbs[37] + gbs[47];
  K_c[183] = exp(-dG[183]);

  k_f[184] = 79100000000.0*pow(T,0.0)*exp(-(28190.358266600855)/T);
   dG[184] =   gbs[2] - gbs[37] + gbs[47];
  K_c[184] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[184]);

  k_f[185] = 2110000000.0000005*pow(T,0.0)*exp(-(-241.54537607940756)/T);
   dG[185] =   gbs[4] - gbs[6] - gbs[35] + gbs[36];
  K_c[185] = exp(-dG[185]);

  k_f[186] = 106000000000000.02*pow(T,-1.41)*exp(-(0.0)/T);
   dG[186] =  - gbs[2] - gbs[35] + gbs[36];
  K_c[186] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[186]);

  k_f[187] = 3900000000.0000005*pow(T,0.0)*exp(-(-120.77268803970378)/T);
   dG[187] =  - gbs[2] + gbs[3] + gbs[35] - gbs[36];
  K_c[187] = exp(-dG[187]);

  k_f[188] = 132000000000.00002*pow(T,0.0)*exp(-(181.15903205955567)/T);
   dG[188] =  - gbs[1] + gbs[4] + gbs[35] - gbs[36];
  K_c[188] = exp(-dG[188]);

  k_f[189] = 40000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[189] =   gbs[1] - gbs[2] - gbs[31] + gbs[35];
  K_c[189] = exp(-dG[189]);

  k_f[190] = 32000000000.000004*pow(T,0.0)*exp(-(166.0624460545927)/T);
   dG[190] =   gbs[0] - gbs[1] + gbs[30] - gbs[31];
  K_c[190] = exp(-dG[190]);

  k_f[191] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[191] =   gbs[1] - gbs[4] - gbs[31] + gbs[38];
  K_c[191] = exp(-dG[191]);

  k_f[192] = 2000000.0000000002*pow(T,1.2)*exp(-(0.0)/T);
   dG[192] =  - gbs[4] + gbs[5] + gbs[30] - gbs[31];
  K_c[192] = exp(-dG[192]);

  k_f[193] = 461.00000000000006*pow(T,2.0)*exp(-(3270.9269677419775)/T);
   dG[193] =   gbs[2] - gbs[3] - gbs[31] + gbs[38];
  K_c[193] = exp(-dG[193]);

  k_f[194] = 1280.0000000000002*pow(T,1.5)*exp(-(50.32195334987657)/T);
   dG[194] =  - gbs[3] + gbs[4] - gbs[31] + gbs[35];
  K_c[194] = exp(-dG[194]);

  k_f[195] = 15000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[195] =   gbs[1] - gbs[30] - gbs[31] + gbs[47];
  K_c[195] = exp(-dG[195]);

  k_f[196] = 20000000000.000004*pow(T,0.0)*exp(-(6969.590538957906)/T);
   dG[196] =   gbs[0] - gbs[5] - gbs[31] + gbs[38];
  K_c[196] = exp(-dG[196]);

  k_f[197] = 21600000000.000004*pow(T,-0.23)*exp(-(0.0)/T);
   dG[197] =   gbs[4] - gbs[31] - gbs[35] + gbs[47];
  K_c[197] = exp(-dG[197]);

  k_f[198] = 365000000000.00006*pow(T,-0.45)*exp(-(0.0)/T);
   dG[198] =   gbs[1] - gbs[31] - gbs[35] + gbs[37];
  K_c[198] = exp(-dG[198]);

  k_f[199] = 3000000000.0000005*pow(T,0.0)*exp(-(0.0)/T);
   dG[199] =  - gbs[2] + gbs[4] + gbs[31] - gbs[32];
  K_c[199] = exp(-dG[199]);

  k_f[200] = 39000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[200] =   gbs[1] - gbs[2] - gbs[32] + gbs[38];
  K_c[200] = exp(-dG[200]);

  k_f[201] = 40000000000.00001*pow(T,0.0)*exp(-(1836.751297270495)/T);
   dG[201] =   gbs[0] - gbs[1] + gbs[31] - gbs[32];
  K_c[201] = exp(-dG[201]);

  k_f[202] = 90000.00000000001*pow(T,1.5)*exp(-(-231.48098540943224)/T);
   dG[202] =  - gbs[4] + gbs[5] + gbs[31] - gbs[32];
  K_c[202] = exp(-dG[202]);

  k_f[203] = 330000000.0*pow(T,0.0)*exp(-(0.0)/T);
   dG[203] =   gbs[1] - gbs[34] + gbs[47];
  K_c[203] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[203]);

  k_f[204] = 130000000000.00002*pow(T,-0.11)*exp(-(2506.033276823853)/T);
   dG[204] =   gbs[1] - gbs[34] + gbs[47];
  K_c[204] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[204]);

  k_f[205] = 5000000000.000001*pow(T,0.0)*exp(-(0.0)/T);
   dG[205] =  - gbs[3] + gbs[6] - gbs[34] + gbs[47];
  K_c[205] = exp(-dG[205]);

  k_f[206] = 25000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[206] =  - gbs[2] + gbs[4] - gbs[34] + gbs[47];
  K_c[206] = exp(-dG[206]);

  k_f[207] = 70000000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[207] =  - gbs[2] + gbs[31] - gbs[34] + gbs[35];
  K_c[207] = exp(-dG[207]);

  k_f[208] = 50000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[208] =   gbs[0] - gbs[1] - gbs[34] + gbs[47];
  K_c[208] = exp(-dG[208]);

  k_f[209] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[209] =  - gbs[4] + gbs[5] - gbs[34] + gbs[47];
  K_c[209] = exp(-dG[209]);

  k_f[210] = 25000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[210] =  - gbs[12] + gbs[13] - gbs[34] + gbs[47];
  K_c[210] = exp(-dG[210]);

  k_f[211] = 44800000000000.01*pow(T,-1.32)*exp(-(372.38245478908664)/T);
   dG[211] =  - gbs[1] - gbs[35] + gbs[38];
  K_c[211] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[211]);

  k_f[212] = 25000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[212] =  - gbs[2] + gbs[4] + gbs[35] - gbs[38];
  K_c[212] = exp(-dG[212]);

  k_f[213] = 900000000.0000001*pow(T,0.72)*exp(-(332.1248921091854)/T);
   dG[213] =   gbs[0] - gbs[1] + gbs[35] - gbs[38];
  K_c[213] = exp(-dG[213]);

  k_f[214] = 13000.000000000002*pow(T,1.9)*exp(-(-478.0585568238275)/T);
   dG[214] =  - gbs[4] + gbs[5] + gbs[35] - gbs[38];
  K_c[214] = exp(-dG[214]);

  k_f[215] = 10000000000.000002*pow(T,0.0)*exp(-(6541.853935483955)/T);
   dG[215] =  - gbs[3] + gbs[6] + gbs[35] - gbs[38];
  K_c[215] = exp(-dG[215]);

  k_f[216] = 77000000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[216] =  - gbs[2] + gbs[14] + gbs[30] - gbs[39];
  K_c[216] = exp(-dG[216]);

  k_f[217] = 40000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[217] =   gbs[1] - gbs[4] - gbs[39] + gbs[46];
  K_c[217] = exp(-dG[217]);

  k_f[218] = 8000000000.000001*pow(T,0.0)*exp(-(3754.0177199007926)/T);
   dG[218] =   gbs[4] - gbs[5] - gbs[39] + gbs[40];
  K_c[218] = exp(-dG[218]);

  k_f[219] = 6140000000.000001*pow(T,0.0)*exp(-(-221.4165947394569)/T);
   dG[219] =   gbs[2] - gbs[3] - gbs[39] + gbs[46];
  K_c[219] = exp(-dG[219]);

  k_f[220] = 295.00000000000006*pow(T,2.45)*exp(-(1127.2117550372352)/T);
   dG[220] =  - gbs[0] + gbs[1] - gbs[39] + gbs[40];
  K_c[220] = exp(-dG[220]);

  k_f[221] = 23500000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[221] =  - gbs[2] + gbs[14] + gbs[35] - gbs[46];
  K_c[221] = exp(-dG[221]);

  k_f[222] = 54000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[222] =  - gbs[1] + gbs[14] + gbs[31] - gbs[46];
  K_c[222] = exp(-dG[222]);

  k_f[223] = 2500000000.0000005*pow(T,0.0)*exp(-(0.0)/T);
   dG[223] =   gbs[1] - gbs[4] + gbs[14] + gbs[35] - gbs[46];
  K_c[223] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[223]);

  k_f[224] = 20000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[224] =   gbs[14] - gbs[30] - gbs[46] + gbs[47];
  K_c[224] = exp(-dG[224]);

  k_f[225] = 2000000000.0000002*pow(T,0.0)*exp(-(10064.390669975315)/T);
   dG[225] =  - gbs[3] + gbs[15] + gbs[35] - gbs[46];
  K_c[225] = exp(-dG[225]);

  k_f[226] = 310000000000.00006*pow(T,0.0)*exp(-(27199.015785608288)/T);
   dG[226] =   gbs[14] + gbs[30] - gbs[46];
  K_c[226] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[226]);

  k_f[227] = 190000000000000.03*pow(T,-1.52)*exp(-(372.38245478908664)/T);
   dG[227] =   gbs[14] - gbs[35] + gbs[37] - gbs[46];
  K_c[227] = exp(-dG[227]);

  k_f[228] = 3800000000000000.5*pow(T,-2.0)*exp(-(402.5756267990126)/T);
   dG[228] =   gbs[15] - gbs[35] - gbs[46] + gbs[47];
  K_c[228] = exp(-dG[228]);

  k_f[229] = 1.0400000000000003e+26*pow(T,-3.3)*exp(-(63707.592940943745)/T);
   dG[229] =   gbs[1] + gbs[39] - gbs[40];
  K_c[229] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[229]);

  k_f[230] = 20.3*pow(T,2.64)*exp(-(2506.033276823853)/T);
   dG[230] =   gbs[1] - gbs[2] - gbs[40] + gbs[46];
  K_c[230] = exp(-dG[230]);

  k_f[231] = 5.07*pow(T,2.64)*exp(-(2506.033276823853)/T);
   dG[231] =  - gbs[2] + gbs[14] + gbs[31] - gbs[40];
  K_c[231] = exp(-dG[231]);

  k_f[232] = 3910000.0000000005*pow(T,1.58)*exp(-(13385.639591067169)/T);
   dG[232] =  - gbs[2] + gbs[4] + gbs[39] - gbs[40];
  K_c[232] = exp(-dG[232]);

  k_f[233] = 1100.0*pow(T,2.03)*exp(-(6728.045162878498)/T);
   dG[233] =   gbs[1] - gbs[4] - gbs[40] + gbs[44];
  K_c[233] = exp(-dG[233]);

  k_f[234] = 4.400000000000001*pow(T,2.26)*exp(-(3220.6050143921007)/T);
   dG[234] =   gbs[1] - gbs[4] - gbs[40] + gbs[45];
  K_c[234] = exp(-dG[234]);

  k_f[235] = 0.16000000000000003*pow(T,2.56)*exp(-(4528.975801488891)/T);
   dG[235] =  - gbs[4] + gbs[14] + gbs[32] - gbs[40];
  K_c[235] = exp(-dG[235]);

  k_f[236] = 33000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[236] =  - gbs[1] - gbs[40] + gbs[41];
  K_c[236] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[236]);

  k_f[237] = 60000000000.00001*pow(T,0.0)*exp(-(201.2878133995063)/T);
   dG[237] =   gbs[10] - gbs[30] - gbs[41] + gbs[47];
  K_c[237] = exp(-dG[237]);

  k_f[238] = 63000000000.00001*pow(T,0.0)*exp(-(23158.1629316132)/T);
   dG[238] =  - gbs[8] + gbs[30] + gbs[39] - gbs[47];
  K_c[238] = exp(-dG[238]);

  k_f[239] = 3120000.0000000005*pow(T,0.88)*exp(-(10129.809209330155)/T);
   dG[239] =  - gbs[9] + gbs[30] + gbs[40] - gbs[47];
  K_c[239] = exp(-dG[239]);

  k_f[240] = 3100000000.0000005*pow(T,0.15)*exp(-(0.0)/T);
   dG[240] =  - gbs[9] + gbs[42] - gbs[47];
  K_c[240] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[240]);

  k_f[241] = 10000000000.000002*pow(T,0.0)*exp(-(37238.24547890866)/T);
   dG[241] =  - gbs[10] + gbs[31] + gbs[40] - gbs[47];
  K_c[241] = exp(-dG[241]);

  k_f[242] = 100000000.00000001*pow(T,0.0)*exp(-(32709.269677419772)/T);
   dG[242] =  - gbs[11] + gbs[31] + gbs[40] - gbs[47];
  K_c[242] = exp(-dG[242]);

  k_f[243] = 19000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[243] =   gbs[2] - gbs[8] - gbs[35] + gbs[39];
  K_c[243] = exp(-dG[243]);

  k_f[244] = 29000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[244] =  - gbs[8] + gbs[14] + gbs[30] - gbs[35];
  K_c[244] = exp(-dG[244]);

  k_f[245] = 41000000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[245] =   gbs[2] - gbs[9] - gbs[35] + gbs[40];
  K_c[245] = exp(-dG[245]);

  k_f[246] = 16200000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[246] =   gbs[1] - gbs[9] - gbs[35] + gbs[46];
  K_c[246] = exp(-dG[246]);

  k_f[247] = 24600000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[247] =  - gbs[9] + gbs[16] + gbs[30] - gbs[35];
  K_c[247] = exp(-dG[247]);

  k_f[248] = 310000000000000.06*pow(T,-1.38)*exp(-(639.0888075434325)/T);
   dG[248] =   gbs[1] - gbs[10] - gbs[35] + gbs[45];
  K_c[248] = exp(-dG[248]);

  k_f[249] = 290000000000.00006*pow(T,-0.69)*exp(-(382.44684545906193)/T);
   dG[249] =   gbs[4] - gbs[10] - gbs[35] + gbs[40];
  K_c[249] = exp(-dG[249]);

  k_f[250] = 38000000000.00001*pow(T,-0.36)*exp(-(291.86732942928415)/T);
   dG[250] =   gbs[1] - gbs[10] - gbs[35] + gbs[43];
  K_c[250] = exp(-dG[250]);

  k_f[251] = 310000000000000.06*pow(T,-1.38)*exp(-(639.0888075434325)/T);
   dG[251] =   gbs[1] - gbs[11] - gbs[35] + gbs[45];
  K_c[251] = exp(-dG[251]);

  k_f[252] = 290000000000.00006*pow(T,-0.69)*exp(-(382.44684545906193)/T);
   dG[252] =   gbs[4] - gbs[11] - gbs[35] + gbs[40];
  K_c[252] = exp(-dG[252]);

  k_f[253] = 38000000000.00001*pow(T,-0.36)*exp(-(291.86732942928415)/T);
   dG[253] =   gbs[1] - gbs[11] - gbs[35] + gbs[43];
  K_c[253] = exp(-dG[253]);

  k_f[254] = 96000000000.00002*pow(T,0.0)*exp(-(14492.722564764454)/T);
   dG[254] =   gbs[5] - gbs[12] - gbs[35] + gbs[40];
  K_c[254] = exp(-dG[254]);

  k_f[255] = 1000000000.0000001*pow(T,0.0)*exp(-(10945.024853598155)/T);
   dG[255] =   gbs[4] - gbs[12] - gbs[35] + gbs[41];
  K_c[255] = exp(-dG[255]);

  k_f[256] = 22000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[256] =   gbs[1] - gbs[2] + gbs[14] - gbs[42] + gbs[47];
  K_c[256] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[256]);

  k_f[257] = 2000000000.0000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[257] =  - gbs[2] + gbs[35] + gbs[40] - gbs[42];
  K_c[257] = exp(-dG[257]);

  k_f[258] = 12000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[258] =   gbs[2] - gbs[3] + gbs[16] - gbs[42] + gbs[47];
  K_c[258] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[258]);

  k_f[259] = 12000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[259] =   gbs[1] - gbs[4] + gbs[16] - gbs[42] + gbs[47];
  K_c[259] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[259]);

  k_f[260] = 100000000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[260] =  - gbs[1] + gbs[10] - gbs[42] + gbs[47];
  K_c[260] = exp(-dG[260]);

  k_f[261] = 98000.00000000001*pow(T,1.41)*exp(-(4277.366034739509)/T);
   dG[261] =  - gbs[2] + gbs[15] + gbs[31] - gbs[45];
  K_c[261] = exp(-dG[261]);

  k_f[262] = 150000.00000000003*pow(T,1.57)*exp(-(22141.659473945692)/T);
   dG[262] =  - gbs[2] + gbs[14] + gbs[38] - gbs[45];
  K_c[262] = exp(-dG[262]);

  k_f[263] = 2200.0*pow(T,2.11)*exp(-(5736.702681885929)/T);
   dG[263] =  - gbs[2] + gbs[4] - gbs[45] + gbs[46];
  K_c[263] = exp(-dG[263]);

  k_f[264] = 22500.000000000004*pow(T,1.7)*exp(-(1912.23422729531)/T);
   dG[264] =  - gbs[1] + gbs[14] + gbs[32] - gbs[45];
  K_c[264] = exp(-dG[264]);

  k_f[265] = 105.00000000000003*pow(T,2.5)*exp(-(6692.8197955335845)/T);
   dG[265] =   gbs[0] - gbs[1] - gbs[45] + gbs[46];
  K_c[265] = exp(-dG[265]);

  k_f[266] = 33000.00000000001*pow(T,1.5)*exp(-(1811.5903205955567)/T);
   dG[266] =  - gbs[4] + gbs[5] - gbs[45] + gbs[46];
  K_c[266] = exp(-dG[266]);

  k_f[267] = 3300.000000000001*pow(T,1.5)*exp(-(1811.5903205955567)/T);
   dG[267] =  - gbs[4] + gbs[15] + gbs[32] - gbs[45];
  K_c[267] = exp(-dG[267]);

  k_f[268] = 11800000000000.002*pow(T,0.0)*exp(-(42632.75887801543)/T);
   dG[268] =   gbs[14] + gbs[31] - gbs[45];
  K_c[268] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[268]);

  k_f[269] = 2100000000000.0002*pow(T,-0.69)*exp(-(1434.1756704714824)/T);
   dG[269] =  - gbs[43] + gbs[45];
  K_c[269] = exp(-dG[269]);

  k_f[270] = 270000000.00000006*pow(T,0.18)*exp(-(1066.8254110173834)/T);
   dG[270] =  - gbs[1] + gbs[4] + gbs[40] - gbs[43];
  K_c[270] = exp(-dG[270]);

  k_f[271] = 170000000000.00003*pow(T,-0.75)*exp(-(1454.304451811433)/T);
   dG[271] =  - gbs[1] + gbs[14] + gbs[32] - gbs[43];
  K_c[271] = exp(-dG[271]);

  k_f[272] = 20000.000000000004*pow(T,2.0)*exp(-(1006.4390669975314)/T);
   dG[272] =  - gbs[44] + gbs[45];
  K_c[272] = exp(-dG[272]);

  k_f[273] = 9000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[273] =   gbs[14] - gbs[27] - gbs[35] + gbs[43];
  K_c[273] = exp(-dG[273]);

  k_f[274] = 610000000000.0001*pow(T,-0.31)*exp(-(145.93366471464208)/T);
   dG[274] =   gbs[1] - gbs[12] - gbs[30] + gbs[41];
  K_c[274] = exp(-dG[274]);

  k_f[275] = 3700000000.0000005*pow(T,0.15)*exp(-(-45.28975801488892)/T);
   dG[275] =   gbs[0] - gbs[12] - gbs[30] + gbs[40];
  K_c[275] = exp(-dG[275]);

  k_f[276] = 540.0*pow(T,2.4)*exp(-(4989.421674640263)/T);
   dG[276] =   gbs[0] - gbs[1] + gbs[32] - gbs[33];
  K_c[276] = exp(-dG[276]);

  k_f[277] = 50000.00000000001*pow(T,1.6)*exp(-(480.57465449132127)/T);
   dG[277] =  - gbs[4] + gbs[5] + gbs[32] - gbs[33];
  K_c[277] = exp(-dG[277]);

  k_f[278] = 9400.000000000002*pow(T,1.94)*exp(-(3250.7981864020267)/T);
   dG[278] =  - gbs[2] + gbs[4] + gbs[32] - gbs[33];
  K_c[278] = exp(-dG[278]);

  k_f[279] = 10000000000.000002*pow(T,0.0)*exp(-(7221.200305707288)/T);
   dG[279] =   gbs[14] - gbs[15] - gbs[31] + gbs[38];
  K_c[279] = exp(-dG[279]);

  k_f[280] = 6160000000000.001*pow(T,-0.752)*exp(-(173.61073905707417)/T);
   dG[280] =   gbs[35] - gbs[36] - gbs[39] + gbs[46];
  K_c[280] = exp(-dG[280]);

  k_f[281] = 3250000000.0000005*pow(T,0.0)*exp(-(-354.76977111662984)/T);
   dG[281] =   gbs[15] - gbs[36] + gbs[37] - gbs[46];
  K_c[281] = exp(-dG[281]);

  k_f[282] = 3000000000.0000005*pow(T,0.0)*exp(-(5686.380728536053)/T);
   dG[282] =   gbs[14] - gbs[15] - gbs[30] + gbs[35];
  K_c[282] = exp(-dG[282]);

  k_f[283] = 33700000000.000008*pow(T,0.0)*exp(-(0.0)/T);
   dG[283] =   gbs[0] + gbs[1] - gbs[2] - gbs[12] + gbs[14];
  K_c[283] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[283]);

  k_f[284] = 6700.000000000001*pow(T,1.83)*exp(-(110.70829736972846)/T);
   dG[284] =   gbs[1] - gbs[2] - gbs[24] + gbs[51];
  K_c[284] = exp(-dG[284]);

  k_f[285] = 109600000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[285] =   gbs[1] - gbs[2] - gbs[25] + gbs[52];
  K_c[285] = exp(-dG[285]);

  k_f[286] = 5000000000000.001*pow(T,0.0)*exp(-(8720.794515533611)/T);
   dG[286] =   gbs[3] - gbs[4] + gbs[5] - gbs[6];
  K_c[286] = exp(-dG[286]);

  k_f[287] = 8000000.000000001*pow(T,0.5)*exp(-(-883.1502812903339)/T);
   dG[287] =   gbs[0] - gbs[4] - gbs[12] + gbs[17];
  K_c[287] = exp(-dG[287]);

  k_f[288] = 1970000000.0000002*pow(T,0.43)*exp(-(-186.19122739454332)/T);
   dG[288] =  - gbs[0] - gbs[9] + gbs[12];
  K_c[288] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[288]);

  k_f[289] = 5800000000.000001*pow(T,0.0)*exp(-(754.8293002481486)/T);
   dG[289] =  2.0*gbs[1] - gbs[3] - gbs[10] + gbs[15];
  K_c[289] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[289]);

  k_f[290] = 2400000000.0000005*pow(T,0.0)*exp(-(754.8293002481486)/T);
   dG[290] =   gbs[2] - gbs[3] - gbs[10] + gbs[17];
  K_c[290] = exp(-dG[290]);

  k_f[291] = 200000000000.00003*pow(T,0.0)*exp(-(5529.879453617937)/T);
   dG[291] =  2.0*gbs[1] -2.0*gbs[10] + gbs[22];
  K_c[291] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[291]);

  k_f[292] = 68200000.00000001*pow(T,0.25)*exp(-(-470.510263821346)/T);
   dG[292] =   gbs[0] - gbs[5] - gbs[11] + gbs[17];
  K_c[292] = exp(-dG[292]);

  k_f[293] = 303000000.00000006*pow(T,0.29)*exp(-(5.5354148684864235)/T);
   dG[293] =   gbs[2] - gbs[3] - gbs[23] + gbs[51];
  K_c[293] = exp(-dG[293]);

  k_f[294] = 1337.0000000000002*pow(T,1.61)*exp(-(-193.23630086352605)/T);
   dG[294] =  - gbs[3] + gbs[6] + gbs[22] - gbs[23];
  K_c[294] = exp(-dG[294]);

  k_f[295] = 2920000000.0000005*pow(T,0.0)*exp(-(909.8209165657685)/T);
   dG[295] =  - gbs[2] + gbs[4] + gbs[51] - gbs[52];
  K_c[295] = exp(-dG[295]);

  k_f[296] = 2920000000.0000005*pow(T,0.0)*exp(-(909.8209165657685)/T);
   dG[296] =  - gbs[2] + gbs[4] + gbs[12] + gbs[14] - gbs[52];
  K_c[296] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[296]);

  k_f[297] = 30100000000.000004*pow(T,0.0)*exp(-(19701.044736476677)/T);
   dG[297] =  - gbs[3] + gbs[6] + gbs[12] + gbs[14] - gbs[52];
  K_c[297] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[297]);

  k_f[298] = 2050000.0000000005*pow(T,1.16)*exp(-(1210.2429780645316)/T);
   dG[298] =   gbs[0] - gbs[1] + gbs[51] - gbs[52];
  K_c[298] = exp(-dG[298]);

  k_f[299] = 2050000.0000000005*pow(T,1.16)*exp(-(1210.2429780645316)/T);
   dG[299] =   gbs[0] - gbs[1] + gbs[12] + gbs[14] - gbs[52];
  K_c[299] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[299]);

  k_f[300] = 23430000.000000004*pow(T,0.73)*exp(-(-560.0833407841262)/T);
   dG[300] =  - gbs[4] + gbs[5] + gbs[12] + gbs[14] - gbs[52];
  K_c[300] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[300]);

  k_f[301] = 3010000000.0000005*pow(T,0.0)*exp(-(5999.8864979057835)/T);
   dG[301] =  - gbs[6] + gbs[7] + gbs[12] + gbs[14] - gbs[52];
  K_c[301] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[301]);

  k_f[302] = 2720.0000000000005*pow(T,1.77)*exp(-(2979.059638312693)/T);
   dG[302] =   gbs[13] + gbs[14] - gbs[52];
  K_c[302] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[302]);

  k_f[303] = 486500000.00000006*pow(T,0.422)*exp(-(-883.1502812903339)/T);
   dG[303] =  - gbs[1] - gbs[28] + gbs[51];
  K_c[303] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[303]);

  k_f[304] = 150000000000.00003*pow(T,0.0)*exp(-(0.0)/T);
   dG[304] =   gbs[1] - gbs[2] + gbs[10] + gbs[15] - gbs[51];
  K_c[304] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[304]);

  k_f[305] = 18100000.000000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[305] =  - gbs[3] + gbs[4] + gbs[14] + gbs[17] - gbs[51];
  K_c[305] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[305]);

  k_f[306] = 23500000.000000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[306] =  - gbs[3] + gbs[4] +2.0*gbs[16] - gbs[51];
  K_c[306] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[306]);

  k_f[307] = 22000000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[307] =  - gbs[1] + gbs[12] + gbs[16] - gbs[51];
  K_c[307] = exp(-dG[307]);

  k_f[308] = 11000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[308] =   gbs[0] - gbs[1] + gbs[28] - gbs[51];
  K_c[308] = exp(-dG[308]);

  k_f[309] = 12000000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[309] =  - gbs[4] + gbs[5] + gbs[28] - gbs[51];
  K_c[309] = exp(-dG[309]);

  k_f[310] = 30100000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[310] =  - gbs[4] + gbs[16] + gbs[18] - gbs[51];
  K_c[310] = exp(-dG[310]);

  k_f[311] = 9430000000.000002*pow(T,0.0)*exp(-(0.0)/T);
   dG[311] =  - gbs[12] - gbs[25] + gbs[50];
  K_c[311] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[311]);

  k_f[312] = 193.00000000000003*pow(T,2.68)*exp(-(1869.9637864814135)/T);
   dG[312] =  - gbs[2] + gbs[4] + gbs[49] - gbs[50];
  K_c[312] = exp(-dG[312]);

  k_f[313] = 1320.0000000000002*pow(T,2.54)*exp(-(3399.7511683176613)/T);
   dG[313] =   gbs[0] - gbs[1] + gbs[49] - gbs[50];
  K_c[313] = exp(-dG[313]);

  k_f[314] = 31600.000000000004*pow(T,1.8)*exp(-(470.0070442878472)/T);
   dG[314] =  - gbs[4] + gbs[5] + gbs[49] - gbs[50];
  K_c[314] = exp(-dG[314]);

  k_f[315] = 0.37800000000000006*pow(T,2.72)*exp(-(754.8293002481486)/T);
   dG[315] =   gbs[6] - gbs[7] - gbs[49] + gbs[50];
  K_c[315] = exp(-dG[315]);

  k_f[316] = 0.0009030000000000002*pow(T,3.65)*exp(-(3600.03254265017)/T);
   dG[316] =  - gbs[12] + gbs[13] + gbs[49] - gbs[50];
  K_c[316] = exp(-dG[316]);

  k_f[317] = 2550.0000000000005*pow(T,1.6)*exp(-(2868.3513409429647)/T);
   dG[317] =  - gbs[12] - gbs[24] + gbs[49];
  K_c[317] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[317]);

  k_f[318] = 96400000000.00002*pow(T,0.0)*exp(-(0.0)/T);
   dG[318] =  - gbs[2] + gbs[17] + gbs[25] - gbs[49];
  K_c[318] = exp(-dG[318]);

  k_f[319] = 36130000000.00001*pow(T,0.0)*exp(-(0.0)/T);
   dG[319] =  - gbs[1] - gbs[49] + gbs[50];
  K_c[319] = pow(101325.0/(th.Ru*T),-1.0)*exp(-dG[319]);

  k_f[320] = 4060.0000000000005*pow(T,2.19)*exp(-(447.8653848139015)/T);
   dG[320] =  - gbs[1] + gbs[12] + gbs[25] - gbs[49];
  K_c[320] = exp(-dG[320]);

  k_f[321] = 24100000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[321] =  - gbs[4] + gbs[18] + gbs[25] - gbs[49];
  K_c[321] = exp(-dG[321]);

  k_f[322] = 25500000.000000004*pow(T,0.255)*exp(-(-474.5360200893361)/T);
   dG[322] =   gbs[3] - gbs[6] - gbs[49] + gbs[50];
  K_c[322] = exp(-dG[322]);

  k_f[323] = 24100000000.000004*pow(T,0.0)*exp(-(0.0)/T);
   dG[323] =   gbs[4] - gbs[6] + gbs[17] + gbs[25] - gbs[49];
  K_c[323] = pow(101325.0/(th.Ru*T),1.0)*exp(-dG[323]);

  k_f[324] = 19270000000.000004*pow(T,-0.32)*exp(-(0.0)/T);
