      ...
      KOKKOS_LAMBDA(const int i, const int j, const int k) {
        ...
        for (int nSub = 0; nSub < nChemSubSteps; nSub++) {
          ...
          // start scope of these temp vars
          {
            ...
            // Reaction #0
            k_f = exp(log(83000000000.00002) - (7252.903136317711 * Tinv));
            ...
            // Reaction #17
            k_f = exp(log(16600000000.000002) - (412.6400174689879 * Tinv));
            ...
            // Reaction #20
            k_f = exp(log(46400000000.00001) - (-251.60976674938286 * Tinv));
            ...
            // Reaction #26
            k_f = exp(log(1750000000.0000002) - (161.03025071960505 * Tinv));
            ...
            // Reaction #27
            k_f = exp(log(580000000000.0001) - (4810.778740248201 * Tinv));
            dG = -gbs[4] + gbs[5] + gbs[6] - gbs[7];
            K_c = exp(-dG);
            q_f = k_f * cs[4] * cs[7];
            q_b = -k_f / K_c * cs[5] * cs[6];
            ...
            // Reaction #28
            k_f = exp(log(602000000.0000001) - (1509.6586004962971 * Tinv));
            ...
            // Reaction #39
            k_f = exp(log(3400000000.0000005) - (347.22147811414834 * Tinv));
            ...
            // Reaction #46
            k_f = exp(log(7600000000.000001) - (201.2878133995063 * Tinv));
            ...
            // Reaction #50
            k_f = exp(log(10560000000.000002) - (754.8293002481486 * Tinv));
            ...
            // Reaction #51
            k_f = exp(log(2640000000.0000005) - (754.8293002481486 * Tinv));
            ...
            // Reaction #75
            k_f = exp(log(1000000000.0000001) - (4025.7562679901257 * Tinv));
            ...
            // Reaction #81
            k_f = exp(log(30830000000.000004) - (14492.722564764454 * Tinv));
            ...
            // Reaction #82
            k_f = exp(log(36000000.00000001) - (4498.782629478966 * Tinv));
            ...
            // Reaction #109
            k_f = exp(log(1600000000.0000002) - (429.74948160794594 * Tinv));
            ...
            // Reaction #114
            k_f = exp(log(386000000.0) + 1.62 * logT -
            ...
            // Reaction #141
            k_f = exp(log(12100000.000000002) - (-299.9188419652644 * Tinv));
            ...
            // Reaction #146
            k_f =
                exp(log(7.8e+41) - 9.147 * logT - (23600.996121092114 * Tinv));
            ...
            // Reaction #149
            k_f = exp(log(20000000000.000004) - (2012.8781339950629 * Tinv));
            ...
            // Reaction #151
            k_f = exp(log(10000000000.000002) - (1006.4390669975314 * Tinv));
            ...
            // Reaction #161
            k_f = exp(log(42200000000.00001) - (30595.74763672496 * Tinv));
            ...
            // Reaction #162
            k_f = exp(log(2000000000.0000002) - (7045.07346898272 * Tinv));
            ...
            // Reaction #164
            k_f = exp(log(20000000000.000004) - (3019.3172009925943 * Tinv));
            ...
            // Reaction #168
            k_f = exp(log(330000000.00000006) - (3874.790407940496 * Tinv));
            ...
            // Reaction #177
            k_f = exp(log(8700000.000000002) - (490.13582562779783 * Tinv));
            ...
            // Reaction #185
            k_f = exp(log(20000000000.000004) - (1006.4390669975314 * Tinv));
