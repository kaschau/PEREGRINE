...
class TestWalls:
    ...
    def test_adiabaticNoSlipWall(self, adv, spdata):
    ...
    def test_adiabaticSlipWall(self, adv, spdata):
    ...
    def test_adiabaticMovingWall(self, adv, spdata):
    ...
    def test_isoTNoSlipWall(self, adv, spdata):
    ...
    def test_isoTSlipWall(self, adv, spdata):
    ...
    def test_isoTMovingWall(self, adv, spdata):
